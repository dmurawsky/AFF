...
"use strict";function ensureValidProtocol(T){return _.endsWith(T,PROTOCOL_END)?T:T.replace(/[\/|:]/g,EMPTY_STRING)+PROTOCOL_END}function ensureValidPath(T){var e=T;return _.startsWith(e,PATH_START)||(e=PATH_START+e),e}function ensureValidQuery(T){var e=EMPTY_STRING,t=!1;return _.forIn(T,function(T,_){e+=[t?QUERY_NTH_SEPARATOR:QUERY_FIRST_SEPARATOR,_,QUERY_PAIR_SEPARATOR,T].join(EMPTY_STRING),t=!0}),e}function create(T){var e="undefined"!=typeof document?document:{},t=_.assign({protocol:_.get(e,"location.protocol",PROTOCOL_DEFAULT),hostname:_.get(e,"location.hostname",HOSTNAME_DEFAULT),path:PATH_DEFAULT,query:QUERY_DEFAULT},T);return[ensureValidProtocol(t.protocol),t.hostname,ensureValidPath(t.path),ensureValidQuery(t.query)].join(EMPTY_STRING)}var _=require("lodash"),PROTOCOL_DEFAULT="https:",PROTOCOL_END="://",HOSTNAME_DEFAULT="www.netflix.com",PATH_START="/",PATH_DEFAULT="/",QUERY_DEFAULT={},QUERY_FIRST_SEPARATOR="?",QUERY_NTH_SEPARATOR="&",QUERY_PAIR_SEPARATOR="=",EMPTY_STRING="";module.exports={create:create};
...
"use strict";function isAbsoluteNetflixUrl(e){var i,t;return e&&(i=e.indexOf(PROTOCOL_END),t=e.indexOf(HOSTNAME_END_FOLDER),0>t&&(t=e.indexOf(HOSTNAME_END_QUERY),0>t&&(t=e.length)),i>=0&&t>=0)?_.endsWith(e.substring(i,t),NETFLIX_DOMAIN_SUFFIX):!1}function isRelativeURL(e){return _.startsWith(e,"/")}var _=require("lodash"),NETFLIX_DOMAIN_SUFFIX=".netflix.com",PROTOCOL_END=":",HOSTNAME_END_FOLDER="/",HOSTNAME_END_QUERY="?";module.exports={isAbsoluteNetflixUrl:isAbsoluteNetflixUrl,isRelativeURL:isRelativeURL};
...
"use strict";var URLGenerator=require("./URLGenerator"),URLSafety=require("./URLSafety"),ctx=require("./contextData"),serverDefs=ctx.getFeatureData("serverDefs"),ROOT="",env=serverDefs&&serverDefs.production?"prod":"test",paths={app:"/browse",genre:"/browse/genre",similars:"/browse/similars",genrenewrelease:"/browse/genre-new-release",hd:"/browse/hd",person:"/browse/person",mylist:"/browse/my-list",watchagain:"/browse/watch-again",recentlyadded:"/browse/recently-added",newarrivals:"/browse/new-arrivals",newrelease:"/browse/new-release",newreleases:"/browse/new-releases",watch:"/watch",watchCharacter:"/watch/character",title:"/title",addToMyList:"/add",subtitle:"/browse/subtitle",subtitles:"/browse/subtitles",search:"/search",audioDescription:"/browse/audio-description",densityAudioDescription:"/audio-description"},urls={paths:paths,page:{app:ROOT+paths.app,genre:ROOT+paths.genre,similars:ROOT+paths.similars,genrenewrelease:ROOT+paths.genrenewrelease,hd:ROOT+paths.hd,person:ROOT+paths.person,mylist:ROOT+paths.mylist,watchagain:ROOT+paths.watchagain,recentlyadded:ROOT+paths.recentlyadded,newrelease:ROOT+paths.newrelease,newreleases:ROOT+paths.newreleases,newarrivals:ROOT+paths.newarrivals,watch:ROOT+paths.watch,watchCharacter:ROOT+paths.watchCharacter,title:ROOT+paths.title,addToMyList:ROOT+paths.addToMyList,subtitle:ROOT+paths.subtitle,subtitles:ROOT+paths.subtitles,search:ROOT+paths.search,audioDescription:ROOT+paths.audioDescription,densityAudioDesc:ROOT+paths.densityAudioDescription,doNotTest:"/DoNotTest",devices:"/Watch",yourAccount:"/YourAccount",affiliates:"/Affiliates",termsOfUse:"/TermsOfUse",privacyPolicy:"/PrivacyPolicy",cookiePolicy:"/Cookies",ratings:"/node/2064",faq:"/node/9977",signOut:"/SignOut?lnkctr=mL",merchweb:{home:"/WiHome",player:"/WiPlayer",viewingActivity:"/WiViewingActivity",editProfiles:"/EditProfiles",mdp:"/WiMovie",manualSortMyList:"/ChangeListOrderCustomer",myList:"/MyList",kidsHome:"/Kids",onRamp:"/Welcome/OnRamp",genre:"/WiGenre",profilesGate:"/ProfilesGate",role:"/RoleDisplay",subtitles:"/Subtitles",newReleases:"/NewReleases",recentAdditionsGallery:"/WiRecentAdditionsGallery",unsupportedCountry:"/Error?type=nonSupportedCountry"},test:{base:"http://www-qa.test.netflix.com"},dvdCo:{hostname:{test:"dvd-www-test-baseline-stable.eng.dvdco.netflix.com",prod:"dvd.netflix.com"},home:"/MemberHome?lnkctr=mhbwse",mdp:"/Movie",dvdUpsell:"/SubscriptionAdd",search:"/Search"},external:{pr:{protocol:"http",hostname:"pr.netflix.com"},mediaCenter:{protocol:"http",hostname:"pr.netflix.com"},investors:{protocol:"http",hostname:"ir.netflix.com"},help:{protocol:"http",hostname:"help.netflix.com"},contact:{protocol:"http",hostname:"help.netflix.com",path:"/contactus"},jobs:{protocol:"http",hostname:"jobs.netflix.com"},support:{protocol:"https",hostname:"support.netflix.com"},blogByRegion:{us:{protocol:"http",hostname:"blog.netflix.com"},nl:{protocol:"http",hostname:"nlblog.netflix.com"},br:{protocol:"http",hostname:"brasilblog.netflix.com"},uk:{protocol:"http",hostname:"ukirelandblog.netflix.com"},nordics:{protocol:"http",hostname:"nordicsblog.netflix.com"},latam:{protocol:"http",hostname:"americalatinablog.netflix.com"}}}},endpoint:{setVideoRating:"/setVideoRating"},param:{merchweb:{playerMovieId:"movieid",trackId:"trkid",uiPlayContext:"tctx",audioDescription:"ad"},dvdUpsell:{preselect:"preselect",dsrc:"dsrc",source:{search:"STRWEB_SEARCH",nav:"STRWEB_NAV"},videoid:"videoid",isShowMember:"isShowMember"}},devParam:{},appStores:{iOS:"http://itunes.com/apps/netflix",android:"https://play.google.com/store/apps/details?id=com.netflix.mediaclient"},getBlogUrl:function(){return URLGenerator.create(this.page.external.blogByRegion.us)},getExternalUrl:function(e){return URLGenerator.create(this.page.external[e])},getMerchWebQueueUrl:function(){return URLGenerator.create({path:this.page.merchweb.myList})},getMerchWebPlayerUrl:function(e,t,r,a){var o={};return o[this.param.merchweb.playerMovieId]=e,o[this.param.merchweb.trackId]=t,o[this.param.merchweb.uiPlayContext]=r,a===!0&&(o[this.param.merchweb.audioDescription]="true"),URLGenerator.create({path:this.page.merchweb.player,query:o})},getMerchWebMDPUrl:function(e){return URLGenerator.create({path:this.page.merchweb.mdp+"/"+e})},getMerchWebGenreUrl:function(e){return URLGenerator.create({path:this.page.merchweb.genre,query:{agid:e}})},getMerchWebRoleUrl:function(e){return URLGenerator.create({path:this.page.merchweb.role,query:{personid:e}})},getMerchWebSubtitlesUrl:function(e){return URLGenerator.create({path:this.page.merchweb.subtitles,query:{sub:e}})},getMerchWebRecentAdditionsGalleryUrl:function(e){return URLGenerator.create({path:this.page.merchweb.recentAdditionsGallery,query:{nRR:"arrivalDate",nRT:"all",genreId:e}})},getViewingActivityUrl:function(){return URLGenerator.create({path:urls.page.merchweb.viewingActivity})},getMerchWebKidsAltGenreUrl:function(e){return URLGenerator.create({path:"/KidsAltGenre",query:{agid:e}})},getTitleUrl:function(e){return urls.page.title+"/"+e},getSearchPersonUrl:function(e,t){return urls.page.search+"/"+e+"/person/"+t},getSearchSuggestionUrl:function(e,t){return urls.page.search+"/"+e+"/suggestion/"+t},getRatingsUrl:function(){var e=this.page.external.support;return URLGenerator.create({protocol:e.protocol,hostname:e.hostname,path:this.page.ratings})},getFAQUrl:function(){var e=this.page.external.support;return URLGenerator.create({protocol:e.protocol,hostname:e.hostname,path:this.page.faq})},getSwitchProfileUrl:function(e,t){var r={tkn:t};return e&&(r.nextpage="/app"),URLGenerator.create({path:"/SwitchProfile",query:r})},getSafeNextUrl:function(e){return e=e.replace(/[<\[\^>\]\*>]/g,""),!URLSafety.isRelativeUrl(e)&&URLSafety.isAbsoluteNetflixUrl(e)?e:URLGenerator.create({path:urls.page.merchweb.home})},makeAkiraPlayerUrl:function(e,t){return isNaN(parseInt(e,10))&&(e=0),"object"!=typeof t&&(t={}),URLGenerator.create({path:paths.watch+"/"+e,query:t})},getDVDCoHomeURL:function(){return URLGenerator.create({hostname:this.page.dvdCo.hostname[env],path:this.page.dvdCo.home})},getDVDCoMDPURL:function(e,t){var r={};return r[this.param.merchweb.trackId]=t,URLGenerator.create({hostname:this.page.dvdCo.hostname[env],path:this.page.dvdCo.mdp+"/"+e,query:r})},getDVDUpsellURL:function(e,t){var r={};return e&&(r[this.param.dvdUpsell.videoid]=e),r[this.param.dvdUpsell.dsrc]=t?this.param.dvdUpsell.source[t]:this.param.dvdUpsell.source.nav,r[this.param.dvdUpsell.preselect]="1u",URLGenerator.create({hostname:this.page.dvdCo.hostname[env],path:this.page.dvdCo.dvdUpsell,query:r})},getDVDCoSearchURL:function(e){return URLGenerator.create({hostname:this.page.dvdCo.hostname[env],path:this.page.dvdCo.search,query:{v1:e}})},getIOSAppStoreURL:function(){return urls.page.appStores.iOS},getAndroidAppStoreURL:function(){return urls.page.appStores.android}};module.exports=urls;
...
"use strict";function _authToken(e){return e.authorize&&userInfo&&userInfo.authURL||null}function _generateUrl(e,r){var t=services[e.service],o=_.assign({},t,e),n={},s={_:(new Date).getTime()},a={};return"api"===e.service&&browserInfo&&browserInfo.esnPrefix&&(n.fallbackEsn=browserInfo.esnPrefix),e.method.toUpperCase()===XHRConstants.METHODS.get?(r&&(s.authURL=r),prod||(s.revision=DEVELOPER_REVISION),o.query=_.assign({},o.query||{},o.data,n,s)):(prod||(a.revision=DEVELOPER_REVISION),o.query=_.assign({},o.query||{},n,a)),URLGenerator.create({protocol:o.protocol,hostname:o.hostname,path:(o.path?o.path.join("/"):DEFAULT_EMPTY_STRING)+o.resource,query:o.query})}function _massageConfiguration(e){var r=_.assign({method:XHRConstants.METHODS.get,headers:{},timeout:15e3,authorize:!1,postType:XHRConstants.POST_TYPES.json},e),t=_authToken(r);return r.method.toUpperCase()===XHRConstants.METHODS.post&&(t&&(r.data.authURL=t),r.postType.toUpperCase()!==XHRConstants.POST_TYPES.text?(r.postBody=JSON.stringify(r.data),r.headers["Content-Type"]="application/json",r.headers.Accept=["application/json","text/javascript","*/*"].join(", ")):r.postBody=_.reduce(r.data,function(e,r,t){return(e===DEFAULT_EMPTY_STRING?DEFAULT_EMPTY_STRING:e+"&")+t+"="+encodeURIComponent(r)},DEFAULT_EMPTY_STRING)),!r.url&&_.isString(r.resource)&&_.isString(r.service)&&(r.url=_generateUrl(r,t)),r}function _openXhr(e){var r=new XMLHttpRequest;return r.open(e.method.toUpperCase(),e.url),r.timeout=e.timeout,r.withCredentials=!0,r.responseType="json",_.forEach(e.headers,function(e,t){r.setRequestHeader(t,e)}),r}function request(e){return Rx.Observable.create(function(r){var t,o=_massageConfiguration(e),n=Date.now();return t=_openXhr(o),t.onload=onXhrComplete.bind(null,r,t,XHRConstants.RESPONSE_TYPES.load,n),t.onerror=onXhrComplete.bind(null,r,t,XHRConstants.RESPONSE_TYPES.error,n),t.ontimeout=onXhrComplete.bind(null,r,t,XHRConstants.RESPONSE_TYPES.timeout,n),t.onabort=onXhrComplete.bind(null,r,t,XHRConstants.RESPONSE_TYPES.abort,n),t.send(o.postBody||DEFAULT_EMPTY_STRING),function(){t.onload=null,t.onerror=null,t.ontimeout=null,t.onabort=null,t.abort(),t=null}})}function onXhrComplete(e,r,t,o){var n;r&&e&&(n=r.status,t===XHRConstants.RESPONSE_TYPES.load&&n>=200&&399>=n?_xhrComplete(e,r,t,o):_xhrError(e,r,t))}function _xhrComplete(e,r,t){var o,n=r.responseType;try{n.toUpperCase()===XHRConstants.POST_TYPES.json&&r.response?o=r.response:n.toUpperCase()===XHRConstants.POST_TYPES.text?o=JSON.parse(r.responseText||""):r.response&&!_.isObject(r.response)&&(o=JSON.parse(r.responseText||"")),e.onNext(o),e.onCompleted()}catch(s){_xhrError(e,r,t)}}function _xhrError(e,r,t){e.onError(new Error("xhr error - "+t),r,t)}var Rx=require("../falkorClient/rxUltraLite"),_=require("lodash"),URLGenerator=require("./URLGenerator"),ctx=require("./contextData"),XHRConstants=require("./XHRConstants"),DEVELOPER_REVISION="latest",DEFAULT_EMPTY_STRING="";if("undefined"!=typeof window)var userInfo=ctx.getFeatureData("userInfo"),serverDefs=ctx.getFeatureData("serverDefs"),services=ctx.getFeatureData("services"),browserInfo=ctx.getFeatureData("browserInfo"),prod=serverDefs.production;module.exports={request:request};
...
"use strict";var isClientContext="undefined"!=typeof window,NON_CSS_PROPERTIES,CSS_PROPERTIES_MAP,KEYFRAMES_PROPERTIES_MAP,EASING_MAP,TRANSFORM_PROPERTY_MAP,TRANSITION_END_EVENTS_MAP,ANIMATION_END_EVENTS_MAP,VENDOR_PREFIXES,CSSAnimations,animationEndEvent,transitionEndEvent,requestAnimationFrame;NON_CSS_PROPERTIES=["target","callback","animation","after","before"],CSS_PROPERTIES_MAP={translate:"transform",translateX:"transform",translateY:"transform",rotate:"transform",scale:"transform",scaleX:"transform",scaleY:"transform",skewX:"transform",skewY:"transform",translateZ:"transform",translate3d:"transform",rotateX:"transform",rotateY:"transform",scale3d:"transform",scaleZ:"transform",matrix:"transform",matrix3d:"transform",origin:"transformOrigin",perspective:"perspective",easing:"transitionTimingFunction",duration:"transitionDuration",delay:"transitionDelay"},KEYFRAMES_PROPERTIES_MAP={name:"animationName",duration:"animationDuration",delay:"animationDelay",easing:"animationTimingFunction",repeat:"animationIterationCount",direction:"animationDirection",fillMode:"animationFillMode"},EASING_MAP={ease:"ease",linear:"linear",easeIn:"ease-in",easeOut:"ease-out",easeInOut:"ease-in-out",stepStart:"step-start",stepEnd:"step-end",steps:"steps",snap:"cubic-bezier(0,1,.5,1)",easeInCubic:"cubic-bezier(.550,.055,.675,.190)",easeOutCubic:"cubic-bezier(.215,.61,.355,1)",easeInOutCubic:"cubic-bezier(.645,.045,.355,1)",easeInCirc:"cubic-bezier(.6,.04,.98,.335)",easeOutCirc:"cubic-bezier(.075,.82,.165,1)",easeInOutCirc:"cubic-bezier(.785,.135,.15,.86)",easeInExpo:"cubic-bezier(.95,.05,.795,.035)",easeOutExpo:"cubic-bezier(.19,1,.22,1)",easeInOutExpo:"cubic-bezier(1,0,0,1)",easeInQuad:"cubic-bezier(.55,.085,.68,.53)",easeOutQuad:"cubic-bezier(.25,.46,.45,.94)",easeInOutQuad:"cubic-bezier(.455,.03,.515,.955)",easeInQuart:"cubic-bezier(.895,.03,.685,.22)",easeOutQuart:"cubic-bezier(.165,.84,.44,1)",easeInOutQuart:"cubic-bezier(.77,0,.175,1)",easeInQuint:"cubic-bezier(.755,.05,.855,.06)",easeOutQuint:"cubic-bezier(.23,1,.32,1)",easeInOutQuint:"cubic-bezier(.86,0,.07,1)",easeInSine:"cubic-bezier(.47,0,.745,.715)",easeOutSine:"cubic-bezier(.39,.575,.565,1)",easeInOutSine:"cubic-bezier(.445,.05,.55,.95)",easeInBack:"cubic-bezier(.6,-.28,.735,.045)",easeOutBack:"cubic-bezier(.175, .885,.32,1.275)",easeInOutBack:"cubic-bezier(.68,-.55,.265,1.55)"},TRANSFORM_PROPERTY_MAP={transform:"transform",WebkitTransform:"-webkit-transform",MozTransform:"-moz-transform",OTransform:"-o-transform",msTransform:"-ms-transform"},TRANSITION_END_EVENTS_MAP={WebkitTransition:"webkitTransitionEnd",MozTransition:"mozTransitionEnd",OTransition:"oTransitionEnd",msTransition:"MSTransitionEnd"},ANIMATION_END_EVENTS_MAP={WebkitAnimation:"webkitAnimationEnd",MozAnimation:"mozAnimationEnd",OAnimation:"oAnimationEnd",msAnimation:"MSAnimationEnd"},VENDOR_PREFIXES=["Webkit","Moz","O","ms"],function(){if(!isClientContext)return"";var n,e,t,i,a,r;n=document.createElement("div"),e=n.style,t="",VENDOR_PREFIXES.forEach(function(n){return n+"Transition"in e?(t=n,void 0):void 0});for(i in CSS_PROPERTIES_MAP)CSS_PROPERTIES_MAP.hasOwnProperty(i)&&(a=CSS_PROPERTIES_MAP[i],r=t+a.charAt(0).toUpperCase()+a.substr(1),r in e&&(CSS_PROPERTIES_MAP[i]=r));for(i in KEYFRAMES_PROPERTIES_MAP)CSS_PROPERTIES_MAP.hasOwnProperty(i)&&(a=KEYFRAMES_PROPERTIES_MAP[i],r=t+a.charAt(0).toUpperCase()+a.substr(1),r in e&&(KEYFRAMES_PROPERTIES_MAP[i]=r));transitionEndEvent="TransitionEvent"in window?"transitionend":TRANSITION_END_EVENTS_MAP[t+"Transition"],animationEndEvent="AnimationEvent"in window?"animationend":ANIMATION_END_EVENTS_MAP[t+"Animation"]}(),requestAnimationFrame=function(){if(!isClientContext)return function(){};var n=0;return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(e){var t=Date.now(),i=Math.max(0,16-(t-n));return n=t+i,setTimeout(function(){e(Date.now())},i)}}(),CSSAnimations={animate:function(n){var e,t,i,a;if(!n)throw new TypeError("React Component - "+this.constructor.displayName+": 'animation' argument must be an object.");if(this.isMounted()&&(e=this._getDOMNode(n.target),e.addEventListener)){n.before&&this._applyStyle(e,n.before);var r=this;(n.callback||n.animation||"undefined"!=typeof n.opacity||n.after)&&(t=this._transitionEndCallback.bind(this,n.callback,n.animation),i=this._transitionEndHandler.bind(this,e,t,function(){n.after&&r._applyStyle(e,n.after),e.removeEventListener(transitionEndEvent,i)}),e.addEventListener(transitionEndEvent,i)),n.keyframes&&n.keyframes.callback&&(a=this._animationEndHandler.bind(this,e,n.keyframes.callback,function(){e.removeEventListener(animationEndEvent,a)}),e.addEventListener(animationEndEvent,a)),requestAnimationFrame(function(){r._applyStyle(e,n)})}},_getDOMNode:function(n){if(n){if("string"==typeof n){if(!this.refs[n])throw new Error("React Component - "+this.constructor.displayName+": 'animation' argument's 'target' property '"+n+"' not found in this.refs.");return this.refs[n].getDOMNode()}return n}return this.getDOMNode()},getAnimationStyle:function(n){var e,t,i,a;a={},"number"==typeof n.duration&&(n.duration+="ms"),"number"==typeof n.delay&&(n.delay+="ms"),n.keyframes&&"number"==typeof n.keyframes.duration&&(n.keyframes.duration+="ms");for(e in n)if(-1===NON_CSS_PROPERTIES.indexOf(e))if(t=CSS_PROPERTIES_MAP[e],i=n[e],t)t in TRANSFORM_PROPERTY_MAP?(a[t]||(a[t]=""),a[t]+=e+"("+i+") "):a[t]="easing"===t?EASING_MAP[i]:i;else if("keyframes"===e)for(e in i)e in KEYFRAMES_PROPERTIES_MAP&&(a[KEYFRAMES_PROPERTIES_MAP[e]]="easing"===e?EASING_MAP[i[e]]:i[e]);else a[e]=i;return a},_transitionEndCallback:function(n,e){if(n&&"function"!=typeof n)throw new Error("React Component - "+this.constructor.displayName+": 'animation' argument's 'callback' property must be a function.");n&&n.call(this),e&&this.animate(e)},_transitionEndHandler:function(n,e,t,i){i.target===n&&(t(),e())},_animationEndHandler:function(n,e,t,i){i.target===n&&(t(),e.call(this))},css:function(n){var e=this._getDOMNode(n.target);return this._applyStyle(e,n)},clearStyles:function(n){n.removeAttribute("style")},_applyStyle:function(n,e){return requestAnimationFrame(function(){e.reset&&(n.removeAttribute("style"),delete e.reset);var t=this.getAnimationStyle(e);for(var i in t)t.hasOwnProperty(i)&&(n.style[i]=t[i])}.bind(this)),n}},module.exports=CSSAnimations;
...
"use strict";var React=require("react"),I18N=require("../../../reactMixins/i18nWithDeps"),URLs=require("../../../utils/urls"),BUNDLE="discovery/akira/Chrome",DVDLink=React.createClass({displayName:"DVDLink",mixins:[I18N],statics:{__meta__:{strings:[{bundle:"discovery/akira/Chrome",ids:["dvd.link"]}]}},componentWillMount:function(){var e=this.getFeatureData("userInfo");this.setState({path:e&&e.isDVD?URLs.getDVDCoHomeURL():URLs.getDVDUpsellURL()})},render:function(){return React.createElement("a",{href:this.state.path},this.getString(BUNDLE,"dvd.link"))}});module.exports=DVDLink;
...
"use strict";var _=require("lodash"),Position=require("../common/position"),Animation=require("./cssAnimation.jsx"),SCROLL_THROTTLE_MS=100,SCROLL_TIMEOUT_MS=150,scrollStart=null,scrollDist=0,BasicScrollMixin={wheelHandler:function(o){Math.abs(o.deltaX)>=Math.abs(o.deltaY)?o.preventDefault():this.throttledScroll()},componentDidMount:function(){var o=document&&document.body;(this.onScroll||this.onScrollEnd||this.onScrollStart)&&(this.throttledScroll||(this.throttledScroll=_.throttle(this._onScroll,SCROLL_THROTTLE_MS)),o&&o.addEventListener("wheel",this.wheelHandler,!1))},componentWillUnmount:function(){var o=document&&document.body;o&&o.removeEventListener("wheel",this.wheelHandler,!1)}},BrowserScroll={mixins:[BasicScrollMixin],componentWillUnmount:function(){"function"==typeof this.onScrollEnd&&this.onScrollEnd(null),clearInterval(this.scrollTimeout)},_onScroll:function(o){var t=this;this.scrollTimeout?clearTimeout(this.scrollTimeout):(scrollStart=Position.getScrollTop(),"function"==typeof this.onScrollStart&&this.onScrollStart(o)),scrollDist=Position.getScrollTop()-scrollStart,"function"==typeof this.onScroll&&this.onScroll(o),this.scrollTimeout=setTimeout(function(){"function"==typeof t.onScrollEnd&&t.onScrollEnd(o),clearTimeout(t.scrollTimeout),t.scrollTimeout=null},SCROLL_TIMEOUT_MS)},getScrollDistance:function(){return scrollDist},scrollTo:function(o,t){window&&window.scrollTo(o,t)},scrollDelta:function(o){window&&window.scrollTo(0,Position.getScrollTop()+o)},scrollDeltaWithAnimation:function(o,t,l,n){if(!window)return!1;var i,r=Position.getScrollTop()+t,e=250;i=Animation.getAnimationStyle({translate3d:"0, "+-1*t+"px,0",duration:l,easing:"cubic-bezier(0.5, 0, 0.1, 1)",delay:n});for(var c in i)i.hasOwnProperty(c)&&(o.style[c]=i[c]);setTimeout(function(){window.requestAnimationFrame(function(){window.scrollTo(0,r),o.removeAttribute("style")})},n+l+e)}};module.exports=BrowserScroll;
...
"use strict";function _switchProfile(e,t,i){var o=e.getValueSync(["summary"]);XHR.request({resource:"/profiles/switch",method:"get",service:"api",protocol:"https",data:{switchProfileGuid:o.guid},timeout:SWITCH_TIMEOUT}).subscribe(t,function(e){401===e.status?window.location=URLs.page.signOut:i()})}function _setProfileGateCookie(){document.cookie="profilesNewSession=0; domain=.netflix.com; path=/;max-age="+PROFILE_INACTIVITY_TIMEOUT_IN_SECONDS+";"}function resetPINState(){try{var e="NFPlaybackSession",t=window.netflix&&window.netflix.clientNotifications&&window.netflix.clientNotifications.getCurrentSession("userSession")||{},i=t.sessionId,o="object"==typeof localStorage?JSON.parse(localStorage.getItem(e)):null;if(!o)return;var s=o[i]||{};s.data&&s.data.pin&&(delete s.data.pin,localStorage.setItem(e,JSON.stringify(o)))}catch(r){}}var _=require("lodash"),XHR=require("./XHR"),URLs=require("./urls"),ContextData=require("./contextData"),EventBus=require("../reactMixins/eventBus"),IdentifierMessages=require("./dynamicMessages/identifier"),SWITCH_TIMEOUT=5e3,ONE_MINUTE_IN_MS=6e4,ONE_MINUTE_IN_SECONDS=60,IDLE_TIMER_IN_MINUTES=ContextData.getData("profilesGate","idle_timer")||30,PROFILE_INACTIVITY_TIMEOUT_IN_MS=IDLE_TIMER_IN_MINUTES*ONE_MINUTE_IN_MS,PROFILE_INACTIVITY_TIMEOUT_IN_SECONDS=IDLE_TIMER_IN_MINUTES*ONE_MINUTE_IN_SECONDS,EVENT_THROTTLE_MS=3e4,profileManager={addedPlaybackHooks:!1,profileTimeout:null,profileIntervalPlayback:null,updateProfileGateAppState:null,resetProfileGateCookieExpiry:function(){var e=this;clearTimeout(this.profileTimeout),_setProfileGateCookie(),this.profileTimeout=setTimeout(function(){e.setActiveView(e.VIEWS.LIST)},PROFILE_INACTIVITY_TIMEOUT_IN_MS)},enableProfileGateSessionTracking:function(){this.throttledResetProfileGateCookieExpiry||(this.throttledResetProfileGateCookieExpiry=_.throttle(this.resetProfileGateCookieExpiry.bind(this),EVENT_THROTTLE_MS)),clearTimeout(this.profileIntervalPlayback),window.addEventListener("keydown",this.throttledResetProfileGateCookieExpiry,!1),window.addEventListener("mousemove",this.throttledResetProfileGateCookieExpiry,!1)},pauseProfileGateSessionTracking:function(){clearTimeout(this.profileTimeout),window.removeEventListener("keydown",this.throttledResetProfileGateCookieExpiry,!1),window.removeEventListener("mousemove",this.throttledResetProfileGateCookieExpiry,!1),this.profileIntervalPlayback=setInterval(this.resetProfileGateCookieExpiry.bind(this),ONE_MINUTE_IN_MS)},switchProfile:function(e){var t=this,i=e.getValueSync(["summary"])||null;i&&!i.isActive?(EventBus.emit("profile:switch"),this.updateProfileGateAppState({activeView:this.VIEWS.LOAD_PROFILE,newProfile:e}),_switchProfile(e,function(){t.onProfileSwitchSuccess(e)},function(){t.onProfileSwitchFailure(e)})):!IdentifierMessages.stub&&IdentifierMessages.isStale()?window.document.location.reload(!0):this.closeGate()},onProfileSwitchSuccess:function(e){var t=e.getValueSync(["summary"]);return resetPINState(),t.isFirstUse?(location.href=URLs.page.merchweb.onRamp,!0):t.isKids?(location.href=URLs.page.merchweb.kidsHome,!0):(document.location.href=URLs.page.app,!0)},onProfileSwitchFailure:function(e){this.updateProfileGateAppState({activeView:this.VIEWS.LOAD_PROFILE_ERROR,newProfile:e})},setActiveView:function(e){this.updateProfileGateAppState({activeView:e})},openProfileList:function(){this.setActiveView(this.VIEWS.LIST)},openCreateProfile:function(){this.setActiveView(this.VIEWS.CREATE_PROFILE)},closeGate:function(){this.setActiveView(this.VIEWS.CLOSED)},isGateOpen:function(e){return e&&e.activeView!==this.VIEWS.CLOSED},isReloadingProfiles:function(e){return e&&e.activeView===this.VIEWS.RELOADING_PROFILES},getCurrentUIView:function(e){var t=null;if(e)switch(e.activeView){case this.VIEWS.LIST:t="profilesGate";break;case this.VIEWS.CREATE_PROFILE:t="addProfile";break;case this.VIEWS.LOAD_PROFILE:case this.VIEWS.LOAD_PROFILE_ERROR:t="profileLoading"}return t},init:function(e){this.updateProfileGateAppState=e,"undefined"!=typeof window&&(EventBus.on("playback:start",this.pauseProfileGateSessionTracking.bind(this)),EventBus.on("playback:end",this.enableProfileGateSessionTracking.bind(this)),this.enableProfileGateSessionTracking(),this.resetProfileGateCookieExpiry())},VIEWS:{CLOSED:0,LIST:1,LOAD_PROFILE:2,LOAD_PROFILE_ERROR:3,CREATE_PROFILE:4,CREATE_PROFILE_ERROR:5,RELOADING_PROFILES:10}};module.exports=profileManager;
...
"use strict";var eventBus=require("./eventBus"),AUTO_FECTH_PENDING_KEY="falkor-auto-fetch-pending";module.exports={mixins:[eventBus],getInitialState:function(){return{generation:-1,key:"",dispose:null}},_getModel:function(t){return"function"==typeof this.getFalkorModel?this.getFalkorModel(t):t.model},_hasValidModel:function(t){var e=this._getModel(t);return e&&e.get&&e.set&&e.call&&e.getValueSync},_hasPQL:function(t){var e=t.pqls;return Array.isArray(e)&&e.length},_normalize:function(t){return t.length>=1&&!Array.isArray(t[0])?[t]:t},fetchData:function(t,e,i,n,r){function a(e,a){this.state[s]&&delete this.state[s],o=!0;var l=t.getBoundValue();this.state.dispose=null,l&&l.__generation&&"error"!==l.$type&&(this.state.generation=l.__generation,this.state.key=l.__key);var u=i===AUTO_FECTH_PENDING_KEY;u&&n(null,t),this.isMounted()&&"onError"===e&&this.setState({fetchDataError:a}),h&&this.isMounted()&&r&&this.forceUpdate(),this.emit("dataFetch:complete",i||null),!u&&n&&n()}var s=JSON.stringify(t._path)+" -> "+JSON.stringify(e);if(this.state[s])return!0;this.state[s]=!0,void 0===r&&(r=!0);var o=!1,h=!1;this.state.fetchDataError=null;var l=t.get.apply(t,this._normalize(e)).subscribe(function(){},a.bind(this,"onError"),a.bind(this,"onComplete"));return h=!0,o||(this.state.dispose=l),o},isLoading:function(){return!!this.state.dispose},ensureDataLoaded:function(t,e,i){var n=this._getModel(e),r=n.getBoundValue();if(!this._hasValidModel(e))throw new Error("React Component - "+this.constructor.displayName+": Must be initialized with a Falkor PathEvaluator model.");if(!this._hasPQL(e))throw new Error("React Component - "+this.constructor.displayName+": Must be initialized with PQLs with which to request data.");return r&&r.__generation&&(this.state.generation=r.__generation,this.state.key=r.__key),this.fetchData(n,e.pqls,t?AUTO_FECTH_PENDING_KEY:null,i)}};
...
"use strict";var React=require("react"),Profile=require("./profile.jsx"),AutoFetch=require("../../../reactMixins/falkor-auto-fetch"),I18N=require("../../../reactMixins/i18nWithDeps"),AVATAR_WIDTH=32,MAX_PROFILE_COUNT=5,ProfilesDropDown=React.createClass({displayName:"ProfilesDropDown",mixins:[AutoFetch,I18N],statics:{getPaths:function(){return[["profilesList","summary"],["profilesList",{to:MAX_PROFILE_COUNT},"summary"],["profilesList",{to:MAX_PROFILE_COUNT},"avatar","images","byWidth",AVATAR_WIDTH]]},__meta__:{strings:[{bundle:"discovery/akira/Chrome",ids:["manage.profiles"]}]}},renderProfiles:function(){var e,r=this.props.model.bind(["profilesList"]),i=r.getValueSync(["summary"]),t=[];for(e=0;e<Math.min(i.length,MAX_PROFILE_COUNT);e++){var a=r.bind([e]);if(a){var s=a.getValueSync(["summary"]);s.isActive||t.push(React.createElement("li",{className:"sub-menu-item profile",key:"profile"+e},React.createElement(Profile,{isClickable:!0,avatarWidth:AVATAR_WIDTH,model:a})))}}return t},render:function(){var e=this.renderProfiles();return React.createElement("ul",{className:"sub-menu-list profiles"},e,React.createElement("li",{className:"sub-menu-item profile-link"},React.createElement("a",{className:"sub-menu-link",href:"/EditProfiles"},this.getString("discovery/akira/Chrome","manage.profiles"))))}});module.exports=ProfilesDropDown;
...
Requireify.register("nf-playprediction",function(t,e,r,i){!function(t){if("object"==typeof i&&"undefined"!=typeof r)r.exports=t();else if("function"==typeof define&&define.amd)define([],t);else{var e;"undefined"!=typeof window?e=window:"undefined"!=typeof global?e=global:"undefined"!=typeof self&&(e=self),e.nfPlayprediction=t()}}(function(){return function e(r,i,o){function n(l,a){if(!i[l]){if(!r[l]){var c="function"==typeof t&&t;if(!a&&c)return c(l,!0);if(s)return s(l,!0);var h=new Error("Cannot find module '"+l+"'");throw h.code="MODULE_NOT_FOUND",h}var u=i[l]={exports:{}};r[l][0].call(u.exports,function(t){var e=r[l][1][t];return n(e?e:t)},u,u.exports,e,r,i,o)}return i[l].exports}for(var s="function"==typeof t&&t,l=0;l<o.length;l++)n(o[l]);return n}({1:[function(t,e){(function(t){e.exports="gibbon"===t.env.PLATFORM||"undefined"!=typeof nrdp?nrdp.mono:Date.now}).call(this,t("_process"))},{_process:4}],2:[function(t,e){var r={CACHE_TYPE:{TRANSIENT:0,SEMI_TRANSIENT:1,PERMANENT:2,name:["transient","semiTransient","permanent"]}};e.exports=r},{}],3:[function(t,e){function r(t,e){var r=t.filter(function(t){return 0===e.filter(function(e){return e.id==t.id}).length});return r}function i(t,e,r){Array.prototype.splice.apply(t,[e,0].concat(r))}function o(t){for(var e=[],r=0,i=t.lolomos.length;i>r;r++)e.push(t.lolomos[r].listContext);return e}function n(t){return t?t.list||t.lolomos:[]}function s(t,e){for(var r=0,i="",o=!1,s=0,l=t.length;l>s;s++)if(void 0===t[s].parent){i=a(n(t[s])),o=!1;for(var c=0,h=e.length;h>c;c++)if(a(n(e[c]))===i){o=!0;break}if(o===!1){r=s;break}}return r}function l(t){var e=t.filter(function(t){return"continueWatching"===t.listContext});return n(e[0])}var a=function(t){for(var e="",r=0;r<t.length;r++)e+=t[r].id+"|";return e},c=function(t,e){var r=t.filter(function(t){return 0===e.filter(function(e){return e.movieId==t.movieId}).length});return r};e.exports={getDiff:r,getDeltaBetweenTwoLists:c,insertArrayAt:i,getRowNames:o,getContinueWatchingTitles:l,getContentList:n,detectScrollHorizontalRow:s}},{}],4:[function(t,e){function r(){if(!s){s=!0;for(var t,e=n.length;e;){t=n,n=[];for(var r=-1;++r<e;)t[r]();e=n.length}s=!1}}function i(){}var o=e.exports={},n=[],s=!1;o.nextTick=function(t){n.push(t),s||setTimeout(r,0)},o.title="browser",o.browser=!0,o.env={},o.argv=[],o.version="",o.versions={},o.on=i,o.addListener=i,o.once=i,o.off=i,o.removeListener=i,o.removeAllListeners=i,o.emit=i,o.binding=function(){throw new Error("process.binding is not supported")},o.cwd=function(){return"/"},o.chdir=function(){throw new Error("process.chdir is not supported")},o.umask=function(){return 0}},{}],"nf-playprediction":[function(t,e){var r=t("./clock.js"),i=t("./enums.js"),o=t("./util").insertArrayAt,n=t("./util").getDeltaBetweenTwoLists,s=t("./util").detectScrollHorizontalRow,l=t("./util").getContinueWatchingTitles,a=t("./util").getContentList,c=function(t,e){this._modelParameter=t||new u,this._prevLolomo=void 0,this._currContent=void 0,this._outputList=[],this._logger=e||console};c.prototype.constructor=c,c.prototype.update=function(t){if(this._event=t.event,this._userExp=t.content.ux,this._currContent=t.content,t.content.grid)this._titlePrs="grid";else if(t.content.lolomos)this._titlePrs="lolomos";else{if(!t.content.item)throw new Error("A payload of grid, lolomos, or item is required in the content.");this._titlePrs="item"}var e,c,u=this._outputList,f=[],d=[];if("grid"==this._titlePrs)e=this._currContent.grid,"FirstLoad"==this._event?(e=e.slice(0,Math.min(e.length,this._modelParameter.gridFirst)),f=this.createArrayMovieClass(e,i.CACHE_TYPE.PERMANENT)):"ScrollVertical"==this._event?(e=e.slice(0,Math.min(e.length,this._modelParameter.gridScroll)),f=this.createArrayMovieClass(e,i.CACHE_TYPE.TRANSIENT)):"search"==this._userExp?(e=e.slice(0,Math.min(this._modelParameter.searchTop,e.length)),f=this.createArrayMovieClass(e,i.CACHE_TYPE.SEMI_TRANSIENT)):"genre"===this._userExp&&(e=e.slice(0,Math.min(this._modelParameter.genre,e.length)),f=this.createArrayMovieClass(e,i.CACHE_TYPE.TRANSIENT));else if("lolomos"==this._titlePrs){c=this._currContent.lolomos;var p,m=l(c);m=m&&m.slice(0,Math.min(this._modelParameter.cwFirst,m.length)),d=this.createArrayMovieClass(m,i.CACHE_TYPE.PERMANENT),m=[];if("FirstLoad"==this._event)m=this.obtainItemsFromTopLeft(c,this._modelParameter.rowFirst,this._modelParameter.colFirst),f=this.createArrayMovieClass(m,i.CACHE_TYPE.PERMANENT);else if("ScrollHorizontal"==this._event){m=this.obtainItemsFromTopLeft(c,this._modelParameter.rowScroll,this._modelParameter.colScroll);var _=s(this._currContent.lolomos,this._prevLolomo.lolomos);p=a(c[_]),p=p.slice(0,Math.min(p.length,this._modelParameter.rowScrollHorizontal)),o(m,m.length,p),f=this.createArrayMovieClass(m,i.CACHE_TYPE.TRANSIENT)}else"ScrollVertical"==this._event||"ViewPortChanged"==this._event?(m=this.obtainItemsFromTopLeft(c,this._modelParameter.rowScroll,this._modelParameter.colScroll),f=this.createArrayMovieClass(m,i.CACHE_TYPE.TRANSIENT)):(m=this.obtainItemsFromTopLeft(c,1,this._modelParameter.colEpisodeList),f=this.createArrayMovieClass(m,i.CACHE_TYPE.TRANSIENT))}else"item"==this._titlePrs&&(f=new h(this._currContent.item.id,i.CACHE_TYPE.SEMI_TRANSIENT,this._currContent.item.offsetStart,r(),this._currContent.item.preplay));o(f,f.length,d),void 0!==typeof this._outputList[0]&&null!==this._outputList[0]&&(this._outputList=this._outputList.filter(this.shouldHold,this)),o(this._outputList,0,f),this._outputList=this.unique(this._outputList);var v=this.trim(this._outputList);"lolomos"===this._titlePrs&&(this._prevLolomo=this._currContent);var T=n(u,v);return v.push({delta:T.length}),v},c.prototype.shouldHold=function(t){return t.cacheType==i.CACHE_TYPE.PERMANENT|t.cacheType==i.CACHE_TYPE.SEMI_TRANSIENT&r()-t.timeAdded<this._modelParameter.holdDuration},c.prototype.unique=function(t){var e,r,i,o=[],n={},s=t.length;for(i=0;s>i;i++)if(e=t[i].movieId,r=t[i],e in n==!1)n[e]=i,r.keep=!0;else{var l=t[n[e]];r.cacheType>l.cacheType?(l.keep=!1,r.keep=!0,l.firstTimeAdded<r.firstTimeAdded&&(r.firstTimeAdded=l.firstTimeAdded),n[e]=i):r.keep=!1}for(i=0;s>i;i++)t[i].keep===!0&&o.push(t[i]);return o},c.prototype.trim=function(t){var e=t.map(function(t){return delete t.keep,t});return e},c.prototype.createArrayMovieClass=function(t,e){for(var i,o=[],n=0,s=t.length;s>n;n++){var l=t[n].id,a=t[n].offsetStart,c=t[n].preplay;i=new h(l,e,a,r(),c),o.splice(n,0,i)}return o},c.prototype.obtainItemsFromTopLeft=function(t,e,r){for(var i,n,s=[],l=0;l<Math.min(e,t.length);l++)i=a(t[l]),n=i.slice(0,Math.min(i.length,r)),o(s,s.length,n);return s};var h=function(t,e,r,o,n){this.movieId=t,this.cacheType=e,this.cacheTypeName=i.CACHE_TYPE.name[e],this.offsetStart=r,this.timeAdded=o,this.firstTimeAdded=o,this.preplay=n},u=function(){this.colEpisodeList=5,this.gridFirst=3,this.gridScroll=2,this.holdDuration=3e5,this.rowFirst=2,this.colFirst=2,this.rowScroll=3,this.colScroll=6,this.rowScrollHorizontal=6,this.searchTop=1,this.genre=6,this.cwFirst=2};e.exports=c},{"./clock.js":1,"./enums.js":2,"./util":3}]},{},[])("nf-playprediction")})});

Requireify.register('js/common/playPrediction/playPredictionConstants.js', function(require, requireAsync, module, exports) {


"use strict";module.exports={PPM_FIRST_LOAD:"FirstLoad",PPM_VIEWPORT_CHANGED:"ViewPortChanged",PPM_SCROLL_VERTICAL:"ScrollVertical",PPM_SCROLL_HORIZONTAL:"ScrollHorizontal",PPM_JAWBONE_OPENED:"JawboneOpened",PPM_PLAY_FOCUS:"PlayFocus",PPM_UNCHANGED:"Unchanged",UI_INIT:"init",UI_FULLSCAN:"pt:fullscan",UI_JAWBONE_OPENED:"jawbone:open",UI_PLAY_FOCUS:"play:focus",UI_SCROLL_VERTICAL:"scroll",UI_SCROLL_HORIZONTAL:"horizontal",UI_SCROLL_NONE:"none",UI_SCROLL_UNKNOWN:"unknown",UX_DISCOVERY:"discovery",UX_SEARCH:"search",UX_GENRE:"genre",UX_WATCH:"watch",UX_UNKNOWN:"unknown",UX_JAWBONE:"jawbone",FAST_PROP_SCAN_DEBOUNCE:"web.ui.play.prediction.scan.debounce",FAST_PROP_PPM_CONFIG_PREFIX:"web.ui.play.prediction.config.test.cell."};
...
"use strict";var React=require("react"),Router=require("react-router"),_=require("lodash"),Link=require("./mainViewLink.jsx"),PlayerCompatibility=require("../../../utils/player/playerFeatureDetection"),URLs=require("../../../utils/urls"),Context=require("../../../utils/contextData"),Position=require("../../../common/position"),PaymentHold=require("../messaging/paymentHold.js"),AppState=require("../../../reactMixins/appstate"),AkiraContext=require("../../../reactMixins/akiraContext"),I18N=require("../../../reactMixins/i18n"),IsomorphicContext=require("../../../reactMixins/isomorphicContextWithDeps"),Animation=require("../../../reactMixins/cssAnimation.jsx"),EventBus=require("../../../reactMixins/eventBus"),PlayPrediction=require("../../../common/playPrediction/playPrediction"),BUNDLE="discovery/akira/Billboard",PlayLink=React.createClass({displayName:"PlayLink",contextTypes:{audioDescription:React.PropTypes.bool},mixins:[I18N,AppState,Animation,Router.Navigation,AkiraContext,IsomorphicContext],statics:{__meta__:{strings:[{bundle:BUNDLE,ids:["billboard.actions.watchNow"]}]}},handleClick:function(e,t){EventBus.emit("playback:requestPlay",_.assign({},this.context,this.props,PlayPrediction.stub?{}:{ppmGUID:PlayPrediction.getLatestGUID()}));var i=this.getFeatureData("umaData")||null;return PaymentHold.preventPlay(i)?(PaymentHold.potentiallyOpen({umaData:i},!0),e.preventDefault(),void 0):this.props.disableClick?!1:this.props.skipTransition?!0:this.transitionToPlayer(t)},handlerHover:function(){EventBus.emit("play:focus",_.assign({},this.props,PlayPrediction.stub?{}:{ppmGUID:PlayPrediction.getLatestGUID()}))},transitionToPlayer:function(e){var t=document.getElementsByClassName("bd"),i=t.length&&t[0],r=!1,a=750,n=this;if(!i)return!0;var o=Position.getScrollTop()+Math.floor(Position.getWindowRect().height/2);document.body.style.overflowX="hidden";var s=function(){r||(r=!0,document.body.style.overflowX=null,n.transitionTo("watchNow",e.params,e.query))};return setTimeout(s,a+100),this.animate({target:i,before:{origin:"50% "+o+"px"},scale:1.04,opacity:0,duration:a,easing:"easeIn",after:{reset:!0,opacity:0},callback:s}),!1},buildUIPlayContext:function(){var e=this.context.rowNum,t=this.context.rankNum,i=this.context.requestId;return e+","+t+","+i},renderMerchwebPlayerLink:function(){var e=URLs.getMerchWebPlayerUrl(this.props.episodeId||this.props.videoId,this.context.trackId,this.buildUIPlayContext(),this.context.audioDescription);return React.createElement("a",React.__spread({},this.props,{tabIndex:this.props.tabIndex,href:e}),this.props.children)},renderMobilePlayerLink:function(){var e={};e[URLs.param.merchweb.trackId]=this.context.trackId,e[URLs.param.merchweb.uiPlayContext]=this.buildUIPlayContext();var t=URLs.makeAkiraPlayerUrl(this.props.episodeId||this.props.videoId,e);return React.createElement("a",React.__spread({},this.props,{tabIndex:this.props.tabIndex,href:t}),this.props.children)},render:function(){var e=this.getFeatureData("browserInfo");if(e.isIOS||e.isAndroid)return this.renderMobilePlayerLink();if(!PlayerCompatibility.canPlayHTML5()||"merchweb"===Context.getData("player","pageType"))return this.renderMerchwebPlayerLink();var t={trackId:this.context.trackId,tctx:this.buildUIPlayContext()};this.context.audioDescription===!0&&(t.ad="true");var i=this.props.episodeId||this.props.videoId;return"undefined"!=typeof this.props.startTime&&(t.t=this.props.startTime),React.createElement(Link,React.__spread({},this.props,{type:"watchNow",params:{id:i},query:t,onClick:this.handleClick,onMouseEnter:this.handlerHover,tabIndex:this.props.tabIndex,role:"link","aria-label":this.getString(BUNDLE,"billboard.actions.watchNow")}),this.props.children)}});module.exports=PlayLink;
...
"use strict";var React=require("react"),GenreNavItem=require("./genreNavItem.jsx"),DVDLink=require("../search/dvdLink.jsx"),SearchBox=require("../search/searchBox.jsx"),AccountDropDown=require("../profile/accountDropDown.jsx"),SystemNotifications=require("./systemNotifications.jsx"),Link=require("../controls/mainViewLink.jsx"),BrowserScroll=require("../../../reactMixins/browserScroll"),FalkorFetch=require("../../../reactMixins/falkor-fetch"),I18N=require("../../../reactMixins/i18n"),IsomorphicContext=require("../../../reactMixins/isomorphicContextWithDeps"),URLs=require("../../../utils/urls"),ProfileManager=require("../../../utils/profileManager"),Position=require("../../../common/position"),UserFeatures=require("../../../features/userFeatures"),Notifications=require("../notifications/notifications.jsx"),prefetchStrategies={minimum:{headerDropDowns:!1,accountDropDown:!0},maximum:{headerDropDowns:!0,accountDropDown:!0}},defaultStrategy=prefetchStrategies.minimum,headerDropDowns=prefetchStrategies.maximum,getPaths=function(e,t){var i=[];return t||(t=defaultStrategy),t.headerDropDowns&&(i=GenreNavItem.getPaths().map(function(e){return["genreList"].concat(e)})),(t.headerDropDowns||t.accountDropDown)&&(i=i.concat(AccountDropDown.getPaths())),i=i.concat(Notifications.getPaths())},BUNDLE="discovery/akira/Chrome:navitem",Header=React.createClass({displayName:"Header",mixins:[I18N,FalkorFetch,BrowserScroll,IsomorphicContext],FADE_IN_THRESHOLD:1,multipleKidsProfiles:!1,showKids:!1,kidProfile:null,statics:{__meta__:{strings:[{bundle:BUNDLE,ids:["home","my.list","new.arrivals","subtitles","ways.to.watch","kids"]}]},getPaths:getPaths,defaultStrategy:defaultStrategy,fullHeaderStrategy:headerDropDowns},getInitialState:function(){var e=!this.props.pinned;return{hasBackground:!1,isSearchBoxFocused:!!this.props.term,trackPinning:e,scrolling:e}},componentWillReceiveProps:function(e){var t=!e.pinned;this.state.trackPinning!==t&&this.setState({trackPinning:t,scrolling:t})},onScroll:function(){if(this.state.trackPinning){var e=this.refs.hdSpace.getDOMNode(),t=e.getBoundingClientRect().top,i=t>0;i!==this.state.scrolling&&this.setState({scrolling:i})}var s=Position.getScrollTop(),a=s>=this.FADE_IN_THRESHOLD&&!this.state.hasBackground||s<this.FADE_IN_THRESHOLD&&this.state.hasBackground;a&&this.setState({hasBackground:!this.state.hasBackground})},handleSearchBoxFocus:function(e){this.setState({isSearchBoxFocused:e})},componentDidMount:function(){var e=prefetchStrategies.maximum;this.fetchData(this.props.pathEvaluator,getPaths(this.getContext(),e,"headerMount",null,e.forceUpdate)),this.onScroll()},onKidsLinkClicked:function(){return!this.multipleKidsProfiles&&this.kidProfile?ProfileManager.switchProfile(this.kidProfile):ProfileManager.openProfileList(),!1},determineKidsStatus:function(){var e,t,i,s=this.props.pathEvaluator.bind(["profilesList"]),a=s.getValueSync(["summary"]),r=0;if(this.multipleKidsProfiles=!1,this.showKids=!1,this.kidProfile=null,a)for(i=0;i<a.length;i++)e=s.bind([i]),e&&(t=e.getValueSync(["summary"]),t.isKids&&(this.showKids=!0,this.kidProfile=e,r>=1&&(this.multipleKidsProfiles=!0),r++))},getSpecialItems:function(){var e,t,i=[],s=this.getFeatureData("userContext"),a="en";s&&(e=s.geo,t=e&&e.preferredLocale,t&&(a=t.language));var r=this.getStrings(BUNDLE);return i=[React.createElement(Link,{className:"sub-menu-link",type:"home"},r.get("home")),React.createElement(Link,{className:"sub-menu-link",type:"queue"},r.get("my.list")),React.createElement(Link,{className:"sub-menu-link",type:"newArrivals"},r.get("new.arrivals"))],UserFeatures.linkToSubtitle()&&i.push(React.createElement(Link,{className:"sub-menu-link",type:"subtitle",id:a},r.get("subtitles"))),i.push(React.createElement(Link,{className:"sub-menu-link",type:"waysToWatch"},r.get("ways.to.watch"))),i},render:function(){var e,t=this.getStrings(BUNDLE),i=this.props.pathEvaluator,s=!1,a=this.getFeatureData("userInfo"),r=React.addons.classSet({"akira-header":!0,"head-opaque":this.state.hasBackground,"search-focused":this.state.isSearchBoxFocused,scrollingHeader:this.state.scrolling,"profile-gated":this.props.isShowingProfilesGate});return a&&(s="US"===a.countryOfSignup),this.getFastProperty("netflix.ui.browse.special.items.disable")||(e=this.getSpecialItems()),this.determineKidsStatus(),React.createElement("div",{className:"hdSpace",ref:"hdSpace"},React.createElement("div",{id:"hdPinTarget",className:r},React.createElement(Link,{className:"logo icon-logoUpdate",type:"home"}),this.props.isShowingProfilesGate?null:React.createElement("ul",null,React.createElement(GenreNavItem,{model:i.bind(["genreList"]),selected:!0,itemType:"genre",pqls:GenreNavItem.getPaths(),className:"browse",specialItems:e}),this.showKids?React.createElement("li",{className:"kids"},React.createElement(Link,{onClick:this.onKidsLinkClicked,href:URLs.page.merchweb.kidsHome},t.get("kids"))):null,s?React.createElement("li",{className:"dvd-link"},React.createElement(DVDLink,null)):null),this.props.isShowingProfilesGate?null:React.createElement("div",{className:"secondary-nav"},React.createElement("div",{className:"nav-element"},React.createElement(SearchBox,{term:this.props.term,model:this.props.model,ref:"searchBox",handleSearchBoxFocus:this.handleSearchBoxFocus})),React.createElement("div",{className:"nav-element"},React.createElement(Notifications,{className:"nav-element",model:this.props.model})),React.createElement("div",{className:"nav-element"},React.createElement(AccountDropDown,{className:"nav-element",model:i,showDVDLink:s,showKidsLink:this.showKids,onKidsLinkClicked:this.onKidsLinkClicked}))),React.createElement(SystemNotifications,{model:this.props.model})))}});module.exports=Header;
...
"use strict";var React=require("react"),Profile=require("../profile/profile.jsx"),I18N=require("../../../reactMixins/i18nWithDeps"),ProfileManager=require("../../../utils/profileManager"),EventBus=require("../../../reactMixins/eventBus"),Transition=require("../../../reactMixins/transition"),AVATAR_WIDTH=320,MAX_PROFILE_COUNT=5,BUNDLE="discovery/akira/Chrome";module.exports=React.createClass({displayName:"exports",mixins:[I18N,Transition],statics:{__meta__:{strings:[{bundle:"discovery/akira/Chrome",ids:["add.profile","whos.watching"]}]}},transitions:{show:{target:"listProfiles",before:{scale:1.1,opacity:0},scale:1,opacity:1,duration:450},hide:{target:"listProfiles",scale:1,opacity:0,duration:350}},componentDidMount:function(){EventBus.emit("app:interactive")},renderChooseableProfiles:function(){var e,r,i=this.props.model.getValueSync(["summary"]),t=Math.min(i.length,MAX_PROFILE_COUNT),a=[];for(e=0;t>e;e++)r=this.props.model.bind([e]),r&&a.push(React.createElement("li",{className:"profile",key:"profile"+e,ref:"profile"+e},React.createElement(Profile,{useDiv:!0,isClickable:!0,avatarWidth:AVATAR_WIDTH,model:r})));return a},handleAddProfile:function(e){ProfileManager.openCreateProfile(),e.preventDefault()},renderAddProfile:function(){return React.createElement("li",null,React.createElement("a",{onClick:this.handleAddProfile},React.createElement("div",{className:"addProfileIcon icon-tvuiAdd"}),React.createElement("span",{className:"profile-name"},this.getString(BUNDLE,"add.profile"))))},render:function(){var e=this.props.model.getValueSync(["summary"]),r=e.length<MAX_PROFILE_COUNT;return React.createElement("div",{className:"centered-div"},React.createElement("div",{key:"listProfiles",ref:"listProfiles",className:"list-profiles"},React.createElement("div",{className:"profile-gate-label"},this.getString(BUNDLE,"whos.watching")),React.createElement("ul",{className:"choose-profile"},this.renderChooseableProfiles(),r?this.renderAddProfile():null)))}});
...
"use strict";var React=require("react"),Profile=require("../profile/profile.jsx"),Transition=require("../../../reactMixins/transition"),ProfileManager=require("../../../utils/profileManager"),EventBus=require("../../../reactMixins/eventBus"),I18N=require("../../../reactMixins/i18nWithDeps"),AVATAR_WIDTH=320,BUNDLE="discovery/partials/profiles_gate";module.exports=React.createClass({displayName:"exports",statics:{__meta__:{strings:[{bundle:BUNDLE,ids:["switch.error","switch.button.tryAgain"]}]}},mixins:[Transition,I18N],transitions:{show:{target:"loadingProfileWrapper",before:{scale:.6,opacity:0},scale:.4,opacity:1,duration:450},hide:{target:"loadingProfileWrapper",scale:.6,opacity:0,duration:350}},componentDidMount:function(){EventBus.emit("app:interactive")},handleRetry:function(){ProfileManager.switchProfile(this.props.newProfile)},renderLoadingError:function(){var e=React.addons.classSet({"profile-load-error":!0,"show-error":this.props.errorLoadingProfile});return React.createElement("p",{className:e},this.getString(BUNDLE,"switch.error"),React.createElement("span",{className:"profile-button",onClick:this.handleRetry},React.createElement("span",null,this.getString(BUNDLE,"switch.button.tryAgain"))))},render:function(){var e=this.props.newProfile;return e?React.createElement("div",{className:React.addons.classSet({"centered-div":!0})},React.createElement("div",null,React.createElement("div",{ref:"loadingProfileWrapper",className:React.addons.classSet({"loading-profile-wrapper":!0})},React.createElement("ul",null,React.createElement(Profile,{useDiv:!0,linked:!1,loading:!0,avatarWidth:AVATAR_WIDTH,errorLoadingProfile:this.props.errorLoadingProfile,model:e}))),this.renderLoadingError())):null}});
...
"use strict";function toObservable(r){return Rx.Observable.create(function(e){return r.subscribe(function(r){e.onNext(r)},function(r){e.onError(r)},function(){e.onCompleted()}),function(){}})}function isValueError(r){return void 0!==r&&"error"===r.$type}function isBoundToError(r){return isValueError(r.getBoundValue())}function hasAnyError(r){var e=!1;return r&&Array.isArray(r)&&r.length>0&&(e=r.some(function(r){return isValueError(r)})),e}function resetCache(r){var e=Object.keys(r._cache).filter(function(r){return"_"!==r[0]&&"$"!==r[0]}).map(function(r){return[r]});r.invalidate.apply(r,e).subscribe()}var Rx=require("../common/nfRx");module.exports={toObservable:toObservable,isValueError:isValueError,isBoundToError:isBoundToError,hasAnyError:hasAnyError,resetCache:resetCache};
...
"use strict";var React=require("react"),_=require("lodash"),EventBus=require("../../../reactMixins/eventBus"),XHR=require("../../../utils/XHR"),AkiraContextMixin=require("../../../reactMixins/akiraContext"),StarBar=React.createClass({displayName:"StarBar",mixins:[AkiraContextMixin],statics:{starClass:{25:"icon-star-25-percent",50:"icon-star-50-percent",75:"icon-star-75-percent",100:"icon-star"}},getInitialState:function(){return{hoverRating:0}},getStarInfo:function(){var t=this.state.hoverRating||this.props.userRating||this.props.predictedRating||this.props.averageRating||0,a=this.state.hoverRating?"hover":this.props.userRating?"personal":"default",e=Math.floor(t),r=t%e,s=0;return r>=.25&&(r>=.75?s=75:r>=.5?s=50:r>=.25&&(s=25)),0>t?(t=0,e=0,s=0):t>5&&(t=5,e=5,s=0),{rating:t,ratingType:a,numWholeStars:e,partialStar:s}},getStarClass:function(t,a){return"star "+t+" "+a},handleEnter:function(t){if(!this.props.readOnly){var a=parseInt(t.target.getAttribute("data-rating"),10)||0;a&&this.setState({hoverRating:a})}},handleLeave:function(){this.props.readOnly||this.setState({hoverRating:null})},handleClick:function(t){if(!this.props.readOnly){var a=parseInt(t.target.getAttribute("data-rating"),10)||0;"function"==typeof this.props.onRating&&this.props.onRating(a),this.props.videoId&&this.sendRating(a)}},sendRating:function(t){EventBus.emit("rating:set",_.assign({rating:t,ratingType:"star",matchScore:null,videoId:this.props.videoId},this.context)),XHR.request({method:"post",data:{},query:{titleid:this.props.videoId,rating:t},resource:"/setVideoRating",service:"api",authorize:!0}).subscribe()},createStar:function(t,a,e){var r=this.getStarClass(a,e);return React.createElement("span",{key:this.props.videoId+"_"+t+e,"data-rating":t,className:r,onMouseEnter:this.handleEnter,onMouseLeave:this.handleLeave})},renderTooltip:function(){return this.state.hoverRating&&this.props.tooltip?React.createElement("div",{className:"starbar-tooltip rating-"+this.state.hoverRating},this.props.tooltip[this.state.hoverRating-1]):null},getStarMarkup:function(){var t,a,e=this.getStarInfo(),r=[],s=[],i=[],n=1;for(t=0;t<e.numWholeStars;t++)r.push(this.createStar(n++,e.ratingType,StarBar.starClass["100"]));for(e.partialStar&&(s.push(this.createStar(n,e.ratingType,StarBar.starClass[e.partialStar])),s.push(this.createStar(n,"sb-placeholder",StarBar.starClass["100"])),n++),a=5-(e.numWholeStars+(e.partialStar?1:0)),t=0;a>t;t++)i.push(this.createStar(n++,"sb-placeholder",StarBar.starClass["100"]));return{left:r,mid:s,right:i}},render:function(){var t=React.addons.classSet,a={starbar:!0,readOnly:this.props.readOnly===!0};this.props.extraClass&&(a[this.props.extraClass]=!0);var e=this.getStarMarkup();return React.createElement("div",{className:t(a),onClick:this.handleClick},this.renderTooltip(),e.left,e.mid.length?React.createElement("div",{className:"transitionWrap"},e.mid):null,e.right)}});module.exports=StarBar;
...
"use strict";var React=require("react"),Resume=require("./../resume.jsx"),Evidence=require("./evidence.jsx"),Link=require("../../controls/mainViewLink.jsx"),PlayButton=require("../../controls/playbutton.jsx"),VideoMeta=require("../../title/videoMeta.jsx"),MyListButton=require("../../title/myListButton.jsx"),PresTrackedContainer=require("../../../../components/presentationTracking/presentationTrackingContainer.jsx"),PresTrackedElement=require("../../../../components/presentationTracking/presentationTrackingElement.jsx"),I18N=require("../../../../reactMixins/i18nWithDeps"),Watched=require("../../../../reactMixins/video/watched"),Utils=require("../../../../utils/reactUtils"),AkiraContext=require("../../../../reactMixins/akiraContext"),MAX_TAGS=10,MAX_GENRES=3,MAX_CAST_SHORT=3,MAX_CAST_LONG=6,BUNDLE="discovery/akira/JawBone",Overview=React.createClass({displayName:"Overview",mixins:[I18N,Watched,AkiraContext],statics:{getPaths:function(e){var t=[[["summary","regularSynopsis","queue","hookEvidence","titleEvidence","watched","episodeCount","info"]],["genres","summary"],["genres",{to:MAX_GENRES-1},["id","name"]],["tags","summary"],["tags",{to:MAX_TAGS-1},["id","name"]],["cast","summary"],["cast",{to:MAX_CAST_LONG-1},["id","name"]]];return e&&(t=t.concat(VideoMeta.getPaths()).concat(Watched.getPaths()).concat(Resume.getPaths()).concat(PlayButton.getPaths())),t}},childContextTypes:{trackId:React.PropTypes.number},getChildContext:function(){var e={};return this.props.trackId&&(e.trackId=this.props.trackId),e},updateMyListMessage:function(){this.forceUpdate()},render:function(){var e,t,a,n,i,s,r,c,l=this.props.model,o=l.getValueSync(["summary"]),u=l.getValueSync(["cast","summary"]),m=l.getValueSync(["genres","summary"]),d=l.getValueSync(["regularSynopsis"]),v=l.getValueSync(["tags","summary"]),g=l.getValueSync(["queue"]),p=l.getValueSync(["info"])||{},y=l.getValueSync(["hookEvidence"]),h=l.getValueSync(["titleEvidence"]),E=l.getValueSync(["episodeCount"]),R=this.getStrings(BUNDLE),S=this.props.isPrePromo,k=[],w=[],M=[],N=[],x=", ",A="",L=this.isInResumeState(),T=this.isInNextUpState(),V=null,_=React.addons.classSet;if(r=_({myListWrapper:!0,prePromo:S}),!o)return null;for(c=S?MAX_CAST_LONG:MAX_CAST_SHORT,t=u?Math.min(c,u.length):0,a=m?Math.min(MAX_GENRES,m.length):0,n=v?Math.min(MAX_TAGS,v.length):0,A="overview.this."+o.type+".is",e=0;t>e;e++){var C=l.bind(["cast",e]);C&&(i=C.getValueSync(["id"]),s=C.getValueSync(["name"]),s&&k.push(React.createElement(Link,{key:"cast"+e,type:"person",id:i},s)))}for(k=Utils.intersperse(k,x),e=0;a>e;e++){var P=l.bind(["genres",e]);P&&(i=P.getValueSync(["id"]),s=P.getValueSync(["name"]),s&&w.push(React.createElement(Link,{key:"genres"+e,type:"genre",id:i},s)))}for(w=Utils.intersperse(w,x),e=0;n>e;e++){var f=l.bind(["tags",e]);f&&(i=f.getValueSync(["id"]),s=f.getValueSync(["name"]),s&&M.push(React.createElement(Link,{key:"tags"+e,type:"tag",id:i},s)))}M=Utils.intersperse(M,x),o.isOriginal||(h&&h.value?N.push(React.createElement(Evidence,{key:"titleEvidence",type:h.type,imgSrc:h.value.boxart},R.get("overview.evidence.watched.by",{title:h.value.title}))):y&&y.value&&N.push(React.createElement(Evidence,{key:"hookEvidence",type:y.type,kind:y.value.kind},y.value.text)));var q=!S,b=o.isOriginal&&p.message,O=!!k.length,X=w.length&&!S,j=N.length&&!S,I=M.length&&!S,U=L||T?"continue":"start",B=S?this.updateMyListMessage:null;return React.createElement("div",{className:"overview"},React.createElement(PresTrackedContainer,null,React.createElement(PresTrackedElement,{videoId:o.id},React.createElement("div",{className:"jawbone-overview-info has-jawbone-nav-transition"},q?React.createElement(VideoMeta,{model:l,withMaturityReasons:!0}):null,"continue"===U?React.createElement(Resume,{model:l,resume:L,isStandalone:!E}):null,"start"===U?React.createElement("span",null,b?React.createElement("div",{className:"supplemental-message"},p.message):null,React.createElement("div",{className:"synopsis"},d?d:React.createElement("b",{style:{color:"#fff"}},R.get("overview.loading"))),React.createElement("div",{className:"listMeta"},O?React.createElement("p",null,R.get("overview.starring")," ",React.createElement("span",{className:"metaList"},k)):null,X?React.createElement("p",null,R.get("overview.genres")," ",React.createElement("span",{className:"metaList"},w)):null,I?React.createElement("p",null,R.get(A)," ",React.createElement("span",{className:"metaList"},M)):null)):null,j?React.createElement("div",{className:"user-evidence"},React.createElement("ul",null,N)):null,g?React.createElement("div",{className:r},React.createElement(MyListButton,{model:this.props.model,videoId:o.id,inQueue:g.inQueue,onStateChange:B}),g.inQueue&&S?React.createElement("div",{className:"myListPrepromoMessage"},R.get("mylist.prepromo.message")):null):null),V)))}});Overview.__meta__={strings:[{bundle:BUNDLE,ids:["overview.starring","overview.genres","overview.this.show.is","overview.this.movie.is","overview.reasons.to.watch","overview.evidence.watched.by","overview.resume","overview.next.up","mylist.prepromo.message","overview.loading"]}]},module.exports=Overview;
...
"use strict";var React=require("react"),EpisodeCard=require("./episodeCard.jsx"),PresTrackedContainer=require("../../../../components/presentationTracking/presentationTrackingContainer.jsx"),Slider=require("../../slider/slider.jsx"),AkiraContext=require("../../../../reactMixins/akiraContext"),AutoFetch=require("../../../../reactMixins/falkor-auto-fetch"),MAX_EPISODES=40,MAX_PLACEHOLDER_EPISODES=5,EpisodesList=React.createClass({displayName:"EpisodesList",mixins:[AutoFetch,AkiraContext],statics:{getPaths:function(e,t,s){var i=[["episodes","summary"],["episodes","current","summary"]],n=s&&void 0!==s.numEpisodes?s.numEpisodes:MAX_EPISODES,r=EpisodeCard.getPaths(e).map(function(e){return["episodes",{from:-1,to:n}].concat(e)});return i.concat(r)}},getDefaultProps:function(){return{seasonIndex:"current"}},getEpisodesList:function(){var e,t,s,i=this.props.model,n=[];if(this.initialLeftmostVisibleIndex=0,!i.getBoundValue())return n;if(s=i.getValueSync(["episodes","current","summary"]),e=i.bind(["episodes"]),t=e.getValueSync(["summary"]),!t)return n;for(var r=0;r<t.length;r++){var o,a,d=e.bind([r]);d.getBoundValue()&&(o=d.getValueSync(["summary"]),s&&(a=o.id===s.id,a&&(this.initialLeftmostVisibleIndex=r>0?r-1:r)),n.push(React.createElement(EpisodeCard,{key:"episode"+r,show:this.props.show,season:i,model:d,current:a,rankNum:r})))}return n},getLoadingEpisodeList:function(){for(var e=[],t=0;MAX_PLACEHOLDER_EPISODES>t;t++)e.push(React.createElement(EpisodeCard,{key:"episode"+t,isLoading:!0,index:t}));return e},render:function(){var e,t,s;return this.props.isLoading?(e=MAX_PLACEHOLDER_EPISODES,t=this.getLoadingEpisodeList(),s="placeholder-episodes-"+this.props.seasonIndex):(e=this.context.columnsInRow-1,t=this.getEpisodesList(),s="season-"+this.props.seasonIndex+this.initialLeftmostVisibleIndex),React.createElement("div",{className:"episodeWrapper"},React.createElement(PresTrackedContainer,null,React.createElement(Slider,{itemsInRow:e,totalItems:t.length,key:s,initialLeftmostVisibleIndex:this.initialLeftmostVisibleIndex,onAdvanceLeft:this.props.onAdvanceLeft,onAdvanceRight:this.props.onAdvanceRight},t)))}});module.exports=EpisodesList;
...
"use strict";var React=require("react"),MoreLikeThisCard=require("./moreLikeThisCard.jsx"),Slider=require("../../slider/slider.jsx"),AkiraContext=require("../../../../reactMixins/akiraContext"),PresTrackedContainer=require("../../../../components/presentationTracking/presentationTrackingContainer.jsx"),I18N=require("../../../../reactMixins/i18nWithDeps"),NUM_PER_PANE=25,MAX_PLACEHOLDER_SIMS=5,BUNDLE="discovery/akira/JawBone";module.exports=React.createClass({displayName:"exports",NUM_PER_PANE:NUM_PER_PANE,statics:{getPaths:function(e,t,r){var i=MoreLikeThisCard.getPaths(e,t,r).map(function(e){return["similars",{to:NUM_PER_PANE}].concat(e)});return[["similars",["summary","trackId"]]].concat(i)},__meta__:{strings:[{bundle:BUNDLE,ids:["more.like.this.unavailable"]}]}},mixins:[I18N,AkiraContext],childContextTypes:{trackId:React.PropTypes.number},getChildContext:function(){return{trackId:this.getTrackId()}},getTrackId:function(){var e=this.props.model,t=e.bind(["similars"]),r=t.getValueSync(["trackId"]);return r},getSims:function(){var e,t=this.props.model,r=t.bind(["similars"]),i=r.getValueSync(["summary"]),n=5,a=[];if(!i)return null;"undefined"!=typeof i.length&&(n=Math.min(this.NUM_PER_PANE,i.length));for(var s=0;n>s;s++)e=r.bind([s]),e.getBoundValue()&&a.push(React.createElement(MoreLikeThisCard,{key:"sims"+s,model:e,rankNum:s}));return a},getLoadingSimsList:function(){for(var e=[],t=0;MAX_PLACEHOLDER_SIMS>t;t++)e.push(React.createElement(MoreLikeThisCard,{key:"sims"+t,isLoading:!0,index:t}));return e},renderError:function(){return React.createElement("p",{className:"unavailable"},this.getString(BUNDLE,"more.like.this.unavailable"))},render:function(){var e,t,r=!0;if(this.props.isLoading)e=MAX_PLACEHOLDER_SIMS,t=this.getLoadingSimsList(),r=!1;else if(e=this.context.columnsInRow-1,t=this.getSims(),null===t||0===t.length)return this.renderError();return React.createElement("div",{className:"simsWrapper"},React.createElement(PresTrackedContainer,null,React.createElement(Slider,{itemsInRow:e,totalItems:t.length,enableLooping:r,onAdvanceLeft:this.props.onAdvanceLeft,onAdvanceRight:this.props.onAdvanceRight},t)))}});
...
"use strict";var React=require("react"),presentationTracking=require("../../../common/presentationTracking/presentationTracking.js"),MIN_HORZ_SWIPE_THRESHOLD_IN_PX=100,WIDTH_100_PERCENT=100,MIN_VERT_SWIPE_THRESHOLD_IN_PX=30,SimpleSlider=React.createClass({displayName:"SimpleSlider",touchStart:{},isAnimating:!1,statics:{MOVE_DIRECTION_RIGHT:1,MOVE_DIRECTION_LEFT:-1},getInitialState:function(){return{translateX:0}},advanceRight:function(){var t=this.refs.sliderContent.getDOMNode(),e=this.calculateMinTranslateX();this.props.onAdvanceRight&&this.props.onAdvanceRight(),this.isAnimating=!0,t.classList.add("animating"),this.setState({translateX:Math.max(e,this.state.translateX-WIDTH_100_PERCENT)})},advanceLeft:function(){var t=this.refs.sliderContent.getDOMNode();this.props.onAdvanceLeft&&this.props.onAdvanceLeft(),this.isAnimating=!0,t.classList.add("animating"),this.setState({translateX:Math.min(0,this.state.translateX+WIDTH_100_PERCENT)})},isTouchEnabled:function(){return"ontouchstart"in window||navigator.maxTouchPoints>0},getReactAnimationStyle:function(t){var e=t?"translate3d("+t+"%, 0px, 0px)":"";return t?{WebkitTransform:e,MozTransform:e,MsTransform:e,OTransform:e,transform:e}:null},handleTouchStart:function(t){var e=this.isTouchEnabled()?t.changedTouches[0]:t;this.touchStart={x:parseInt(e.clientX,10),y:parseInt(e.clientY,10)}},handleTouchMove:function(t){var e=this.isTouchEnabled()?t.changedTouches[0]:t,n=this.touchStart.x-e.clientX,i=Math.abs(this.touchStart.y-e.clientY);this.isAnimating||(n>MIN_HORZ_SWIPE_THRESHOLD_IN_PX&&MIN_VERT_SWIPE_THRESHOLD_IN_PX>i&&this.isRightNavActive()?(this.advanceRight(),this.touchStart={}):-MIN_HORZ_SWIPE_THRESHOLD_IN_PX>n&&MIN_VERT_SWIPE_THRESHOLD_IN_PX>i&&this.isLeftNavActive()&&(this.advanceLeft(),this.touchStart={})),Math.abs(n)>Math.abs(i)&&t.preventDefault()},calculateMinTranslateX:function(){if(this.refs.sliderContent){var t=this.refs.sliderContent.getDOMNode(),e=t.scrollWidth,n=t.clientWidth,i=-100*(e/n-1);return i}return 0},hasMorePagesOnLeft:function(){return this.state.translateX<0},hasMorePagesOnRight:function(){var t=this.state.translateX-this.calculateMinTranslateX();if(this.refs.sliderContent){var e=this.refs.sliderContent.getDOMNode(),n=e.clientWidth,i=t/100*n;return i>3}return t>1},isLeftNavActive:function(){return this.hasMorePagesOnLeft()},isRightNavActive:function(){return this.hasMorePagesOnRight()},animationComplete:function(){var t=this.refs.sliderContent.getDOMNode();t.classList.remove("animating"),this.isAnimating=!1,presentationTracking.requestScan()},componentDidMount:function(){var t=this.refs.sliderContent.getDOMNode();this.isTouchEnabled()&&(t.addEventListener("pointerdown",this.handleTouchStart),t.addEventListener("pointermove",this.handleTouchMove)),t.addEventListener("transitionend",this.animationComplete),this.forceUpdate()},componentWillUnmount:function(){var t=this.refs.sliderContent.getDOMNode();this.isTouchEnabled()&&(t.removeEventListener("pointerdown",this.handleTouchStart),t.removeEventListener("pointermove",this.handleTouchMove)),t.removeEventListener("transitionend",this.animationComplete)},render:function(){var t,e,n,i=React.addons.classSet,a=this.getReactAnimationStyle(this.state.translateX),s="sliderContent",r={simpleSlider:!0,slider:!0};return this.props.className&&(r[this.props.className]=!0),n={sliderMask:!0},t={handle:!0,handleLeft:!0,active:this.isLeftNavActive()},e={handle:!0,handleRight:!0,active:this.isRightNavActive()},React.createElement("div",{className:i(r)},React.createElement("div",{className:i(t),ref:"handleLeft",onClick:this.advanceLeft,onMouseEnter:this.props.onMouseEnterSliderHandle,onMouseLeave:this.props.onMouseLeaveSliderHandle},React.createElement("b",{className:"indicator-icon icon-leftCaret"})),React.createElement("div",{className:i(e),ref:"handleRight",onClick:this.advanceRight,onMouseEnter:this.props.onMouseEnterSliderHandle,onMouseLeave:this.props.onMouseLeaveSliderHandle},React.createElement("b",{className:"indicator-icon icon-rightCaret"})),React.createElement("div",{className:i(n),ref:"sliderMask"},React.createElement("div",{className:s,ref:"sliderContent",style:a,onTouchStart:this.handleTouchStart,onTouchMove:this.handleTouchMove},this.props.children)))}});module.exports=SimpleSlider;
...
"use strict";var React=require("react"),_=require("lodash"),DetailsColumn=React.createClass({displayName:"DetailsColumn",getDefaultProps:function(){return{classSet:{}}},render:function(){var e=_.merge({detailsItem:!0},this.props.classSet);return React.createElement("div",{key:this.props.key,className:React.addons.classSet(e)},this.props.children)}});module.exports=DetailsColumn;
...
"use strict";var React=require("react"),_=require("lodash"),DetailsColumn=require("./detailsColumn.jsx"),Link=require("../../controls/mainViewLink.jsx"),I18N=require("../../../../reactMixins/i18nWithDeps"),PathEvaluatorUtils=require("../../../../utils/pathEvaluatorUtils"),BUNDLE="discovery/akira/JawBone:details",MAX_SUBS_LANGS_LINES=13,LanguageSupportColumn=React.createClass({displayName:"LanguageSupportColumn",mixins:[I18N],_renderSubsOrLangsContainer:function(e,t){return React.createElement("div",null,t?React.createElement("div",{className:"listLabel"},t):null,e.length?React.createElement("ul",null,e):null)},_renderSubsOrLangsColumns:function(e,t,n){return _.flatten(_.chunk(e,MAX_SUBS_LANGS_LINES).map(function(e,a){var r=0===a?t:void 0;return React.createElement(DetailsColumn,{key:"detailsMedia"+a,classSet:{detailsMedia:!0}},0===a&&n?{additionalNodes:n}:null,this._renderSubsOrLangsContainer(e,r))}.bind(this)))},render:function(){var e,t,n=[],a=[],r={},s={},l=0,i=0,u=this.getStrings(BUNDLE);return e=this.props.model.getValueSync(["subtitles"]),t=this.props.model.getValueSync(["audio"]),!e&&!t||PathEvaluatorUtils.hasAnyError([e,t])?null:(e.map(function(e,t){var a=e.englishName;a&&!r[a]&&(r[a]=!0,n.push(React.createElement("li",{key:"subtitles"+t},React.createElement(Link,{type:"subtitle",id:e.bcp47Code},a))))}),t.map(function(e,t){var n=e.languageName;n&&!s[n]&&(s[n]=!0,a.push(React.createElement("li",{key:"languages"+t},n)))}),l=n?n.length:0,i=a?a.length:0,MAX_SUBS_LANGS_LINES>i+l?React.createElement(DetailsColumn,null,this.props.children,this._renderSubsOrLangsContainer(a,u.get("audio")),this._renderSubsOrLangsContainer(n,u.get("subtitles"))):React.createElement("span",null,this._renderSubsOrLangsColumns(a,u.get("audio"),this.props.children),this._renderSubsOrLangsColumns(n,u.get("subtitles"))))}});LanguageSupportColumn.__meta__={strings:[{bundle:BUNDLE,ids:["audio","subtitles"]}]},module.exports=LanguageSupportColumn;
...
"use strict";var React=require("react"),_=require("lodash"),MaturityRating=require("../../title/maturityRating.jsx"),Festival=require("./festival.jsx"),People=require("./people.jsx"),Tags=require("./tags.jsx"),Reviews=require("./reviews.jsx"),AvailabilityInfo=require("./availabilityInfo.jsx"),SimpleSlider=require("../../slider/simpleSlider.jsx"),CommonSenseSection=require("../../title/commonSense.jsx"),DVDAvailability=require("../../title/dvdAvailability.jsx"),Copyright=require("./copyright.jsx"),AkiraContext=require("../../../../reactMixins/akiraContext"),ctx=require("../../../../utils/contextData"),I18N=require("../../../../reactMixins/i18nWithDeps"),DetailsColumn=require("./detailsColumn.jsx"),LanguageSupportColumn=require("./languageSupportColumn.jsx"),MAX_AWARD_LINES=14,MAX_FESTIVALS=10,BUNDLE="discovery/akira/JawBone:details",Details=React.createClass({displayName:"Details",mixins:[I18N,AkiraContext],statics:{getPaths:function(e,t,a){var i,s=Festival.getPaths(e,t,a).map(function(e){return["festivals",{to:MAX_FESTIVALS}].concat(e)});return i=MaturityRating.getPaths(e,t,a).concat(CommonSenseSection.getPaths(e,t,a)).concat(s).concat(People.getPaths(e,t,a)).concat(Tags.getPaths(e,t,a)).concat([[["subtitles","audio"]],["festivals","length"]]).concat(AvailabilityInfo.getPaths(e,t,a)).concat(Copyright.getPaths(e,t,a))}},placeHolder:function(){return React.createElement("div",{className:"jawBoneDetails"},"Loading details...")},render:function(){var e,t=this.props.model,a=t.getValueSync(["summary"]),i=t.getValueSync(["commonsense"]),s=t.getValueSync(["delivery"]),l=t.getValueSync(["festivals","length"]),n=this.getStrings(BUNDLE),r="show"===a.type,o=i&&"US"===_.get(this.getFeatureData("geo"),"preferredLocale.country"),c=React.createElement(People,{model:t}),u=React.createElement(Tags,{model:t,isShow:r}),m=this.getFeatureData("userInfo"),d=!1,g="",p=[];for(s&&(g=s.hasUltraHD?n.get("available.in.super.HD"):s.hasHD?n.get("available.in.HD"):n.get("available.in.standard.def")),m&&(d=m.isDVD),c&&p.push(React.createElement(DetailsColumn,{key:"detailsPeople",classSet:{detailsPeople:!0}},d?React.createElement("div",{key:"detailsDVD"},React.createElement(DVDAvailability,{model:t,videoId:a.id,isShow:r})):null,c)),u&&p.push(React.createElement(DetailsColumn,{key:"detailsTags",classSet:{detailsTags:!0}},u)),p.push(React.createElement(DetailsColumn,{key:"detailsMaturity",classSet:{detailsMaturity:!0}},React.createElement("div",{className:"listLabel"},n.get("ratings")),React.createElement(MaturityRating,{model:t,withLinkToDetail:!0,withDescription:!0,withReasons:!0,useCountryStyling:!0}),o?React.createElement(CommonSenseSection,{alertType:i.alertType,description:i.description,ageRecommendation:i.ageRecommendation}):null,React.createElement(Copyright,{key:"detailsCopyright",model:t,classSet:{"details-copyright":!0}}))),e=0;l>e;e++)p.push(React.createElement(DetailsColumn,{key:"festival"+e,classSet:{detailsFestivals:!0}},React.createElement(Festival,{model:t.bind(["festivals",e]),maxLines:MAX_AWARD_LINES})));if(p.push(React.createElement(LanguageSupportColumn,{model:t},g?React.createElement("div",{className:"listLabel"},n.get("streaming")):null,g)),ctx.get("fastProps","netflix.ui.akira.memberReviewsEnabled")){var v=3===this.context.columnsInRow?3:2,h=React.createElement(DetailsColumn,{key:"detailsReviews",classSet:{detailsReviews:!0,doubleWidth:!0}},React.createElement("div",{className:"listLabel"},n.get("reviews")),React.createElement(Reviews,{model:t,pqls:Reviews.getPaths(this.props.model,null,null)}));p.splice(v,0,h)}return React.createElement(SimpleSlider,{className:"jawBoneDetails",onAdvanceLeft:this.props.onAdvanceLeft,onAdvanceRight:this.props.onAdvanceRight},p)}});Details.__meta__={strings:[{bundle:BUNDLE,ids:["ratings","streaming","available.in.HD","available.in.super.HD","available.in.standard.def","award.nominee","reviews"]}]},module.exports=Details;
...
"use strict";var React=require("react"),Transition=require("../../../reactMixins/transition"),FADE_DURATION=750;module.exports=React.createClass({displayName:"exports",mixins:[Transition],transitions:{crossFade:FADE_DURATION},componentWillLeave:function(e){this.isMounted()&&e()},render:function(){var e={backgroundImage:"url("+this.props.url+")"},r=this.props.isPreload?"preload-image":"";return React.createElement("div",{className:"image-rotator-image "+r,style:e})}});
...
"use strict";var React=require("react"),ImageRotator=require("../title/imageRotator.jsx"),ImageExtension=require("../../../common/imageExtension"),IsomorphicContext=require("../../../reactMixins/isomorphicContextWithDeps");module.exports=React.createClass({displayName:"exports",mixins:[IsomorphicContext],statics:{getPaths:function(e,t,r){var i=ImageExtension.getExtensionForOpaqueImage(e),n=[["BGImages",r.height,i],["bookmarkPosition"]];return n=r.isShow?n.concat([["current","interestingMoment",r.size,i]]):n.concat([["recentInterestingMoment",r.height,i]])}},getInitialState:function(){return{isLoaded:!1}},getBackgroundImages:function(){var e,t=[],r=this.props.model,i=r.getValueSync(["BGImages",this.props.height]),n=ImageExtension.getExtensionForOpaqueImage(this.getContext());if(this.props.watched&&(e=this.props.isStandalone?r.getValueSync(["recentInterestingMoment",this.props.height,n]):r.getValueSync(["current","interestingMoment",this.props.size,n])))return t=[e.url];if(i&&i[n])for(var o=0;o<i[n].length;o++){var s=i[n][o].url;s&&t.push(s)}return t},render:function(){var e=this.getBackgroundImages();return React.createElement(ImageRotator,React.__spread({},this.props,{duration:this.props.duration,images:e,preloadImage:this.props.preloadImage}))}});
...
"use strict";var React=require("react"),HeroImages=require("../title/heroImages.jsx"),ImageExtension=require("../../../common/imageExtension"),Watched=require("../../../reactMixins/video/watched"),SvgBlur=require("../../../components/svg/blur.jsx"),SIZE="_665x375",HEIGHT=470,ROTATION_DURATION=3300,JawBoneImages=React.createClass({displayName:"JawBoneImages",mixins:[Watched],statics:{getPaths:function(e,a,t){var s=[[["bookmarkPosition","runtime"]],["boxarts",SIZE,ImageExtension.getExtensionForOpaqueImage(e)]];return s.concat(HeroImages.getPaths(e,null,{isShow:t.isShow,height:HEIGHT,size:SIZE}))}},getInitialState:function(){return{hasWebKitFilter:!1}},render:function(){var e,a=this.props.model,t=React.addons.classSet,s=a.getValueSync("bookmarkPosition"),i="nav-shadow",o=null;return e=t({background:!0,blur:this.props.dim,dim:this.props.dim}),React.createElement("div",{className:e},React.createElement(SvgBlur,null),React.createElement(HeroImages,{id:"jawBoneIR"+this.props.id,stop:this.props.dim,duration:ROTATION_DURATION,className:"jawBoneBackground",auto:!0,isStandalone:this.props.isStandalone,model:a,style:o,bookmarkPosition:s,height:HEIGHT,size:SIZE,variance:120,watched:this.hasBeenWatched()}),React.createElement("div",{className:"vignette"}),React.createElement("div",{className:i}))}});module.exports=JawBoneImages;
...
"use strict";var React=require("react"),JawBoneNavigations=React.createClass({displayName:"JawBoneNavigations",getDefaultProps:function(){return{leftNavActive:!0,rightNavActive:!0}},handleClick:function(e){var t=this;return t.props.onClick?function(){t.props.onClick(e)}:void 0},render:function(){return null}});module.exports=JawBoneNavigations;
...
"use strict";var React=require("react"),PathEvaluatorUtils=require("../../../utils/pathEvaluatorUtils"),Overview=require("./overview/overview.jsx"),Episodes=require("./episodes/episodes.jsx"),MoreLikeThis=require("./moreLikeThis/moreLikeThis.jsx"),Trailers=require("./trailers/trailers.jsx"),ShowDetails=require("./details/details.jsx"),PlayButton=require("./overview/playButton.jsx"),Pane=require("./pane.jsx"),Menu=require("./menu.jsx"),Background=require("./background.jsx"),Navigation=require("./overview/navigation.jsx"),Link=require("../controls/mainViewLink.jsx"),ImageExtension=require("../../../common/imageExtension"),JawBoneLink=require("../../../reactMixins/jawBoneLink"),AkiraContext=require("../../../reactMixins/akiraContext"),FalkorFetch=require("../../../reactMixins/falkor-fetch"),IsomorphicContext=require("../../../reactMixins/isomorphicContextWithDeps"),FastProperty=require("../../../reactMixins/fastProperty"),Prefetch=require("../../../reactMixins/prefetch"),Scheduler=require("../../../reactMixins/scheduler"),KeyCodes=require("../../../common/keyCodes"),EventBus=require("../../../reactMixins/eventBus"),Transition=require("../../../reactMixins/transition"),OVERVIEW="Overview",EPISODES="Episodes",TRAILERS="Trailers",MORE_LIKE_THIS="MoreLikeThis",SHOW_DETAILS="ShowDetails",SHORT_TITLE_LENGTH=30,DELAY_PREFETCH=600,BOJACK_VIDEO_ID=70300800,prefetchStrategies={allJawBonePanes:{all:!0}},getPaths=function(e,t,a){t||(t={all:!1}),a||(a={isShow:!0});var i=ImageExtension.getExtensionForTransparentImage(e);Overview.pql={originalsLogo:["bb2OGLogo","_400x90",i]};var n=void 0===a.isShow?!0:a.isShow,s=[[["summary","title","maturity","bookmarkPosition","runtime","requestId","availability"]]].concat([["trailers",["summary","recapCount"]]]).concat([Overview.pql.originalsLogo]).concat(Overview.getPaths(e,null,{isShow:n})).concat(Background.getPaths(e,null,{isShow:n}));return n&&(s=s.concat([["episodeCount"]])),t.all&&(s=s.concat(MoreLikeThis.getPaths(e,t,a)).concat(ShowDetails.getPaths(e,t,a)).concat(Trailers.getPaths(e,t,a)).concat(Episodes.getPaths(e,t,{seasonIndex:"current"}))),s},JawBoneContent=React.createClass({displayName:"JawBoneContent",childContextTypes:{parentContext:React.PropTypes.object,rowNum:React.PropTypes.number,rankNum:React.PropTypes.number,requestId:React.PropTypes.string,trackId:React.PropTypes.number},getChildContext:function(){var e,t={rowNum:0,rankNum:0};return this.props.isStandaloneJawbone||(t.parentContext={rowNum:this.context.rowNum,rankNum:this.context.rankNum,requestId:this.context.requestId,trackId:this.context.trackId},t.trackId=this.context.jawBoneTrackId||this.context.trackId),e=this.getRequestId(),e&&(t.requestId=e),t},mixins:[AkiraContext,JawBoneLink,FalkorFetch,IsomorphicContext,Prefetch,Scheduler,FastProperty,Transition],transitions:{show:function(e){this.animateInfo(e,{before:{translateX:"30px",opacity:0},translateX:"0px",opacity:1,delay:250,duration:500})},hide:function(e,t){this.animateInfo(e,{opacity:0,duration:250}),setTimeout(t,950)}},animateInfo:function(e,t){if(!this.props.isFirstJaw)for(var a=e.getElementsByClassName("has-jawbone-nav-transition"),i=0;i<a.length;i++)t.target=a[i],this.animate(t)},ID:"jawBone-container",statics:{getPaths:getPaths,prefetchStrategies:prefetchStrategies},getDefaultProps:function(){return{disableClose:!1,disableNavigation:!1}},getRequestId:function(){return this.props.model.getValueSync(["requestId"])},getDefaultPane:function(){return"Overview"},getInitialState:function(){return{data:void 0,isShow:!0,visiblePane:this.getDefaultPane(this.props.model),hasClickedMenu:!1,hasPaneData:[],hasBojackEasterEgg:this.hasBojackEasterEgg(this.props.model)}},hasBojackEasterEgg:function(){var e=this.props.model.getValueSync(["summary"]),t=e&&e.id;return t===BOJACK_VIDEO_ID&&this.fastProperty("netflix.ui.akira.originals.easterEgg.bojack.enabled")},handleNavHover:function(){var e=this.props.model.getValueSync(["summary"]),t=e&&e.id,a=this.state.hasPaneData,i=this;if(t&&!a[t]){var n=this.getStrategy("netflix.ui.akira.prefetch.jawBoneNavHover");this.queue(function(){i.fetchData(i.props.model,getPaths(i.getContext(),n,{isShow:i.state.isShow}),"jawBoneNavHover",null,n.forceUpdate)}),a[t]=!0,this.setState({hasPaneData:a})}},getVisiblePane:function(e,t){var a,i=this.props.model;switch(e){case OVERVIEW:a=React.createElement(Overview,{model:i,isPrePromo:t.isPrePromo});break;case EPISODES:a=React.createElement(Episodes,{model:i,trackId:this.context.jawBoneEpisodeTrackId,disableNavigation:this.props.disableNavigation,isLoading:this.isLoading(),onAdvanceLeft:this._handleAdvanceLeftInTab,onAdvanceRight:this._handleAdvanceRightInTab,hasBojackEasterEgg:this.state.hasBojackEasterEgg});break;case TRAILERS:a=React.createElement(Trailers,{model:i,trackId:this.context.jawBoneTrailerTrackId,isLoading:this.isLoading(),onAdvanceLeft:this._handleAdvanceLeftInTab,onAdvanceRight:this._handleAdvanceRightInTab});break;case MORE_LIKE_THIS:a=React.createElement(MoreLikeThis,{model:i,isLoading:this.isLoading(),onAdvanceLeft:this._handleAdvanceLeftInTab,onAdvanceRight:this._handleAdvanceRightInTab});break;case SHOW_DETAILS:a=React.createElement(ShowDetails,{model:i,isLoading:this.isLoading(),onAdvanceLeft:this._handleAdvanceLeftInTab,onAdvanceRight:this._handleAdvanceRightInTab})}return React.createElement(Pane,{key:"pane-"+e},a)},tabClicked:function(e){var t=this;return function(){EventBus.emit("jawbone:tab:open",{tab:e}),t.setState({visiblePane:e,hasClickedMenu:!0})}},_handleAdvanceRightInTab:function(){EventBus.emit("jawbone:tab:scrollRight")},_handleAdvanceLeftInTab:function(){EventBus.emit("jawbone:tab:scrollLeft")},_handleClick:function(e){var t=e.target;this._isClickFromMenu(t)||EventBus.emit("jawbone:tab:click",{tab:this.state.visiblePane,name:t.innerText||t.alt,url:t.href,type:t.type||t.parent&&t.parent.type})},_isClickFromMenu:function(e){return e.parentElement&&"menu"===e.parentElement.className||e.parentElement.parentElement&&"menu"===e.parentElement.parentElement.className?!0:!1},prefetchOnLoad:function(){var e=this,t=this.props.model,a=t.getValueSync(["summary"]),i=a&&a.id,n=this.state.hasPaneData;i&&!n[i]&&(this.mountPrefetchTimeout=setTimeout(function(){var t=getPaths(e.getContext(),prefetchStrategies.allJawBonePanes,{isShow:e.state.isShow});e.fetchData(e.props.model,t),n[i]=!0,e.setState({hasPaneData:n})},DELAY_PREFETCH))},handleCloseJawBone:function(){EventBus.emit("jawbone:close",{reason:"explicit"}),this.closeJawBone()},handleKeyDown:function(e){switch(e&&e.which){case KeyCodes.ESC:this.handleCloseJawBone();break;case KeyCodes.ENTER:this.refs.closeJawboneButton.getDOMNode().contains(e.target)&&this.handleCloseJawBone()}},componentWillMount:function(){this.suppressOriginalsJaw=this.fastProperty("netflix.ui.akira.originals.jawbone.disable")||!1},componentDidMount:function(){this.prefetchOnLoad(),document.location.search.indexOf("focus")>0&&this.getDOMNode().focus()},componentDidUpdate:function(){this.prefetchOnLoad()},componentWillUnmount:function(){clearTimeout(this.mountPrefetchTimeout)},componentWillReceiveProps:function(e){var t,a;e.jawBoneRankNum!==this.props.jawBoneRankNum&&(t=e.model,a=t.getValueSync(["episodeCount"]),this.setState({isShow:a,visiblePane:this.getDefaultPane(t)}))},getOriginalsModel:function(){var e=this.props.model,t=e.getValueSync(["summary"]),a=t&&t.isOriginal;if(!a||this.suppressOriginalsJaw)return{};var i=e.getValueSync(["trailers",["summary"]]),n=e.getValueSync(["availability"])||{},s=e.getValueSync(Overview.pql.originalsLogo)||{url:""},r={isOriginal:!0,logoUrl:s.url,isPrePromo:!n.isPlayable,hasTrailers:i&&!!i.length,hasRecaps:e.getValueSync(["trailers",["recapCount"]])};return r.suppressMenu=r.isPrePromo&&!r.hasTrailers,r},renderTitle:function(e,t,a,i){var n;n=t.isOriginal?t.logoUrl?React.createElement("img",{alt:e,className:"logo "+(a?"":"small-logo"),src:t.logoUrl}):null:e;var s="title has-jawbone-nav-transition";return e.length>SHORT_TITLE_LENGTH&&(s+=" title-small"),React.createElement(Link,{type:"title",params:{id:i}},React.createElement("div",{className:s},n))},render:function(){var e=this.props.model,t=this.getOriginalsModel(),a=e.getValueSync(["summary"]),i=e.getValueSync(["title"]),n=e.getValueSync(["episodeCount"]),s=this.state.visiblePane;if(PathEvaluatorUtils.isValueError(a)||!a||!i)return null;n||s!==EPISODES||(s=OVERVIEW);var r=s===OVERVIEW,o=React.addons.classSet({jawBonePanes:!0,"offset-for-logo":t.isOriginal&&!r});return React.createElement("div",{id:a.id,className:"jawBoneContainer slider-hover-trigger-layer",onKeyDown:this.handleKeyDown,onClick:this._handleClick,tabIndex:1},React.createElement(Background,{id:a.id,dim:!r,model:e,isStandalone:!n}),r?React.createElement(PlayButton,{model:e}):null,r&&!this.props.disableNavigation?React.createElement(Navigation,{onClick:this.props.handleNavClick,leftNavActive:this.props.leftNavActive,rightNavActive:this.props.rightNavActive}):null,React.createElement("div",{className:"jawBone"},t.suppressMenu?null:React.createElement(Menu,{hasEpisodes:n,hasTrailers:t.hasTrailers,hasRecaps:t.hasRecaps,isPrePromo:t.isPrePromo,visiblePane:s,tabClicked:this.tabClicked,onMouseEnter:this.handleNavHover,hasBojackEasterEgg:this.state.hasBojackEasterEgg}),this.props.disableClose?null:React.createElement("a",{className:"close-button icon-close",ref:"closeJawboneButton",onClick:this.handleCloseJawBone,tabIndex:1}),React.createElement("div",{className:"jawBoneCommon"},this.renderTitle(i,t,r,a.id),React.createElement("div",{className:o},this.getVisiblePane(s,t)))))}});module.exports=JawBoneContent;
...
"use strict";var React=require("react"),_=require("lodash"),VideoMeta=require("../title/videoMeta.jsx"),MyListButton=require("../title/myListButton.jsx"),HeroImages=require("../title/heroImages.jsx"),PlayButton=require("../controls/playbutton.jsx"),Progress=require("../jawBone/progress.jsx"),SliderItem=require("../slider/sliderItem.jsx"),Link=require("../controls/mainViewLink.jsx"),Animation=require("../../../reactMixins/cssAnimation.jsx"),AkiraContext=require("../../../reactMixins/akiraContext"),Watched=require("../../../reactMixins/video/watched"),I18N=require("../../../reactMixins/i18n"),Context=require("../../../reactMixins/isomorphicContextWithDeps"),JawBoneLink=require("../../../reactMixins/jawBoneLink"),EventBus=require("../../../reactMixins/eventBus"),Position=require("../../../common/position"),MouseUtils=require("../../../utils/mouseUtils"),SIZE="_665x375",HEIGHT=470,IMAGE_ROTATOR_FIRST_DELAY=2e3,IMAGE_ROTATOR_DURATION=2e3,EXPAND_DURATION=400,BOB_SCALE=1.82,BOB_PRE_EXPAND_SCALE=.54945055,Z_INDEX_DEFAULT=null,Z_INDEX_CLOSING=2,Z_INDEX_OPEN=4,MAX_SYNOPSIS_LENGTH=160,HOVER_RED="#E50914",BUNDLE="discovery/akira/Common",BobCard=React.createClass({displayName:"BobCard",mixins:[JawBoneLink,Animation,Watched,I18N,Context,AkiraContext],statics:{DELAY_OPEN_FAST:100,DELAY_OPEN_SLOW:400,getPaths:function(e,t,i){return i||(i={}),[["summary"],["title"],["availability"],["synopsis"],["queue"],["episodeCount"],["info"]].concat([["current",["summary","runtime","bookmarkPosition","creditsOffset"]]]).concat(VideoMeta.getPaths(e)).concat(HeroImages.getPaths(e,null,{isShow:i.isShow,height:HEIGHT,size:SIZE})).concat(Watched.getPaths()).concat(PlayButton.getPaths())},__meta__:{strings:[{bundle:BUNDLE,ids:["label.resume","label.next.up","watched.title.bob"]}]}},getInitialState:function(){return{disablePlayButton:!1,inPlayHitZone:!1}},componentDidMount:function(){this.openBOB()},openBOB:function(){var e=this,t=BOB_SCALE;this.preExpandScale=BOB_PRE_EXPAND_SCALE;var i=100*t,a=(i-100)/-2;this.setParentZIndex(Z_INDEX_OPEN),this.setState({disablePlayButton:!0}),setTimeout(function(){e.isMounted()&&e.setState({disablePlayButton:!1})},EXPAND_DURATION+250),this.animate({before:{scale:this.preExpandScale,visibility:"visible",width:i+"%",height:i+"%",top:a+"%",left:a+"%"},scale:1,easing:"cubic-bezier(0.5, 0, 0.1, 1)",duration:EXPAND_DURATION}),this.animate({target:"title-art",opacity:0,duration:EXPAND_DURATION,easing:"linear",after:{display:"none"}}),this.animate({target:"jawbone-chevron",before:{translateY:"-10px",opacity:0},translateY:"0px",opacity:1,duration:EXPAND_DURATION,delay:200,after:{reset:!0}}),this.pushSiblings(t)},pushSiblings:function(e){var t=Position.getRect(this.props.parentNode),i=t.width*e,a=(i-t.width)/2,n=1;this.props.onBobOpen(a,n,EXPAND_DURATION)},getParentSliderItem:function(){for(var e=this.getDOMNode();e=e.parentNode;)if(e.classList&&e.classList.contains(SliderItem.className))return e;return null},setParentZIndex:function(e){var t=this.getParentSliderItem();t&&this.css({target:t,zIndex:e})},componentWillLeave:function(e){this.animate({scale:this.preExpandScale,duration:EXPAND_DURATION,easing:"cubic-bezier(0.5, 0, 0.1, 1)"}),this.animate({target:"title-art",before:{display:"block"},opacity:1,duration:EXPAND_DURATION});var t=this;this.setParentZIndex(Z_INDEX_CLOSING),setTimeout(function(){t.isMounted()&&(t.setParentZIndex(Z_INDEX_DEFAULT),e())},EXPAND_DURATION),this.props.onBobClose(EXPAND_DURATION)},onEnterPlayHitZone:function(){this.isVideoPlayable()&&this.css({target:"playButton",opacity:null}),this.css({target:"jawbone-chevron",fontWeight:"normal"}),this.toggleBigHitZoneHover(!0)},onEnterJawHitZone:function(){this.isVideoPlayable()&&this.css({target:"playButton",opacity:.2}),this.css({target:"jawbone-chevron",fontWeight:"bold"}),this.toggleBigHitZoneHover(!1)},onClickPlayHitZone:function(){this.isVideoPlayable()&&this.refs.playButton.getDOMNode().click()},onClickJawHitZone:function(e){MouseUtils.modifiedClick(e)||(e&&e.preventDefault(),EventBus.emit("jawbone:open",_.assign({},this.context,this.props,{trigger:"bob",matchScore:null})),this.props.onJawOpen&&this.props.onJawOpen(),this.openJawBoneAtRankNum(this.context.rankNum,this.props.videoId))},toggleBigHitZoneHover:function(e){this.setState({inPlayHitZone:e}),this.css({target:"jawbone-chevron",color:e?null:HOVER_RED}),this.isVideoPlayable()&&this.css({target:this.getDOMNode().querySelector(".icon-play"),color:e?HOVER_RED:null})},getFeatureSet:function(e){var t={titlePosition:"inside",chevronSize:"normal",meta:!0,year:!0,synopsis:!0,queue:!!e.queue,cssClass:"",watchedTitle:!1,progress:!1,progressSummary:!1,playButton:"normal",playPosition:"normal",playHitZone:"normal",state:"play"};return t.cssClass="big-hitzone-bob",t.playHitZone="large",this.isInResumeState()?(t.state="resume",t.watchedTitle=!0,t.progress=!0,t.progressSummary=!0):this.isInNextUpState()&&(t.state="nextup",t.watchedTitle=!0),"play"!==t.state&&(t.synopsis=!1,t.meta=!1),t.synopsis||(t.playPosition="lower"),e.summary.isOriginal&&!this.isVideoPlayable()&&(t.meta=!1,t.queue=!1,e.info&&e.info.message&&(t.tagline=e.info&&e.info.message)),t},getData:function(){var e=this.props.model;return{title:e.getValueSync(["title"]),summary:e.getValueSync(["summary"]),heroImages:e.getValueSync(["heroImages"]),queue:e.getValueSync(["queue"]),bookmarkPosition:e.getValueSync(["bookmarkPosition"]),episodeRuntime:e.getValueSync(["current","runtime"]),episodeBookmark:e.getValueSync(["current","bookmarkPosition"]),isStandalone:e.getValueSync(["episodeCount"])<=0,info:e.getValueSync(["info"]),synopsis:_.trunc(e.getValueSync(["synopsis"]),{length:MAX_SYNOPSIS_LENGTH,separator:/\s/,omission:"…"})}},isVideoPlayable:function(){var e=this.props.model.getValueSync(["availability"]),t=e&&e.isPlayable;return!e||t},getResumeBobTitle:function(){var e=this.getResumeParams();return this.getString(BUNDLE,"watched.title.bob",e)},render:function(){var e=this.props.model,t=this.getData(),i=this.getFeatureSet(t),a=React.addons.classSet,n={"bob-card":!0};n[i.cssClass]=!0;var s={"bob-play":!0,"bob-play-lower":"lower"===i.playPosition};s["bob-play-"+i.playButton]=!0,"large"===i.playHitZone&&(s.hitZoneBased=!0,s.hitZoneHover=this.state.inPlayHitZone);var o={"bob-title":!0},r={"icon-akiraCaretDown":!0,"bob-jawbone-chevron":!0};r["chevron-size-"+i.chevronSize]=!0;var l=i.watchedTitle&&!t.isStandalone?this.getResumeBobTitle():"",c=i.progress?React.createElement(Progress,{runtime:t.episodeRuntime,bookmarkPosition:t.episodeBookmark,current:!0,showSummary:i.progressSummary}):null;return React.createElement("div",{className:a(n),key:"bob-"+t.summary.id},React.createElement(HeroImages,{firstDelay:IMAGE_ROTATOR_FIRST_DELAY,duration:IMAGE_ROTATOR_DURATION,className:"bob-background",auto:!0,isStandalone:t.isStandalone,model:e,preloadImage:this.props.titleArt,bookmarkPosition:t.bookmarkPosition,height:HEIGHT,size:SIZE,watched:this.hasBeenWatched()}),React.createElement("div",{className:"bob-outline"}),React.createElement("div",{className:"bob-overlay",ref:"overlay"},React.createElement("div",{className:"bob-play-hitzone",onMouseEnter:this.onEnterPlayHitZone,onClick:this.onClickPlayHitZone}),React.createElement(Link,{type:"title",params:{id:t.summary.id},preventClick:!0,className:"bob-jaw-hitzone",onMouseEnter:this.onEnterJawHitZone,onClick:this.onClickJawHitZone}),this.isVideoPlayable()?React.createElement(PlayButton,{ref:"playButton",model:e,onMouseEnter:this.onEnterPlayHitZone,className:a(s),disableClick:this.state.disablePlayButton,tabIndex:0}):null,React.createElement("div",{className:"bob-info"},"inside"===i.titlePosition?React.createElement("div",{className:a(o)},t.title):null,"inside"===i.titlePosition&&i.watchedTitle?React.createElement("div",{className:"watched-title",dangerouslySetInnerHTML:{__html:l}}):null,i.meta?React.createElement(VideoMeta,{model:e,readOnly:!0,suppressYear:!i.year}):null,i.tagline?React.createElement("div",{className:"tagline"},t.info.message):null,i.synopsis?React.createElement("div",{className:"synopsis"},t.synopsis):null,i.queue?React.createElement("div",{className:"mylist-wrapper"},React.createElement(MyListButton,{model:e,videoId:t.summary.id,inQueue:t.queue.inQueue,showToolTip:!0})):null,"inside"===i.titlePosition?c:null,"under"===i.titlePosition?React.createElement("div",{ref:"title-under",className:"bob-title-under-pos"},React.createElement("div",{className:"bob-title-under",dangerouslySetInnerHTML:{__html:l}}),c):null,React.createElement("div",{className:a(r),ref:"jawbone-chevron"}))),React.createElement("img",{src:this.props.titleArt,ref:"title-art",className:"bob-title-art"}))}});module.exports=BobCard;
...
"use strict";var ctx=require("../utils/contextData"),_=require("lodash"),serverDefs=ctx.getFeatureData("serverDefs"),isTestEnvironment=serverDefs&&!serverDefs.production,TesterParams={getTesterParamFlag:function(e){return"true"===this.getTesterParamValue(e)},getTesterParamValue:function(e){return isTestEnvironment?_.get(this.getQuery(),e,null):void 0}};module.exports=TesterParams;
...
"use strict";var React=require("react"),_=require("lodash"),PathEvaluatorUtils=require("../../../utils/pathEvaluatorUtils"),ErrorTitleCard=require("./errorTitleCard.jsx"),BobCard=require("./bobCard.jsx"),MotionBoxArt=require("./motionBoxArt.jsx"),JawBone=require("../jawBone/jawBone.jsx"),ImageExtension=require("../../../common/imageExtension"),JawBoneLink=require("../../../reactMixins/jawBoneLink"),AkiraContext=require("../../../reactMixins/akiraContext"),FalkorFetch=require("../../../reactMixins/falkor-fetch"),IsomorphicContext=require("../../../reactMixins/isomorphicContextWithDeps"),FalkorPureRender=require("../../../reactMixins/falkorPureRenderMixin"),Scheduler=require("../../../reactMixins/scheduler"),EventBus=require("../../../reactMixins/eventBus"),I18N=require("../../../reactMixins/i18n"),FastProperty=require("../../../reactMixins/fastProperty"),Watched=require("../../../reactMixins/video/watched"),MotionBoxArtTest=require("../../../reactMixins/ab/motionBoxArtTest"),KeyCodes=require("../../../common/keyCodes"),CSSAnimation=require("../../../reactMixins/cssAnimation.jsx"),PresTrackedElement=require("../../../components/presentationTracking/presentationTrackingElement.jsx"),TitleCardFocus=require("./titleCardFocus.jsx"),ReactTransitionGroup=React.addons.TransitionGroup,SIZE="_342x192",DELAY_JAWBONE=300,BUNDLE="discovery/akira/Common",prefetchStrategies={bobs:{bobs:!0},jawBones:{jawBones:!0}},getPaths=function(e,t,i){t||(t={}),i||(i={});var o,n,s=[["summary"],["title"],["boxarts",SIZE,ImageExtension.getExtensionForOpaqueImage(e)]];return t.bobs&&(o=BobCard.getPaths(e,t,i),s=s.concat(o)),t.jawBones&&(n=JawBone.getPaths(e,t,{isShow:i.isShow}),s=s.concat(n)),s},TitleCard=React.createClass({displayName:"TitleCard",mixins:[I18N,JawBoneLink,CSSAnimation,FalkorFetch,IsomorphicContext,FalkorPureRender,Scheduler,AkiraContext,FastProperty,MotionBoxArtTest,Watched],isHovering:!1,statics:{extension:function(e){return ImageExtension.getExtensionForOpaqueImage(e)},getPaths:getPaths,getSize:function(){return SIZE},__meta__:{strings:[{bundle:"discovery/akira/Common",ids:["loading","evidence.mylist","evidence.continueWatching","evidence.dayEvidence"]}]}},childContextTypes:{rankNum:React.PropTypes.number},getChildContext:function(){return{rankNum:this.props.rankNum}},getInitialState:function(){return{hasBob:!1,hideJawFocus:!1}},placeHolder:function(){var e="lockup title_card "+(this.props.className||"");return React.createElement("div",{className:e},React.createElement("div",{className:"video-artwork tc-load"},this.getString(BUNDLE,"loading")))},eventOpenJaw:function(e){this.props.myJawBoneOpen||"keydown"!==e.type&&this.state.hasBob||(EventBus.emit("jawbone:open",_.assign({},this.context,this.props,{trigger:"miniBob",matchScore:null})),this.openJawBoneAtRankNum(this.props.rankNum,this.props.videoId,e.type),this.onOpenJaw(!0))},handleKeyDown:function(e){var t=this;switch(e&&e.which){case KeyCodes.ENTER:this.eventOpenJaw(e);break;case KeyCodes.ESC:this.props.myJawBoneOpen&&(EventBus.emit("jawbone:close",{reason:"explicit"}),this.closeJawBone(function(){t.getDOMNode().focus()}))}},handleClick:function(e){this.eventOpenJaw(e)},handleMouseOver:function(e){var t=document.activeElement||document.body;e.preventDefault(),e&&e.currentTarget&&this.getDOMNode().contains(e.currentTarget)&&!this.state.hasBob&&(t!==document.body&&t.blur(),this.handleEnter())},handleMouseOut:function(e){e.preventDefault(),(e&&!e.relatedTarget||e.relatedTarget&&!this.getDOMNode().contains(e.relatedTarget))&&this.handleLeave()},handleFocus:function(){this.handleEnter()},handleBlur:function(e){var t=this.getDOMNode(),i=e&&e.relatedTarget||document.activeElement;e&&"blur"===e.type&&i&&t.contains(i)&&i!==t||this.handleLeave()},handleEnter:function(){var e=this,t=this.getContext();if(this.isHovering=!0,this.showHoverPulse=!1,this.fetchedBOBData||(this.queue(function(){var i=prefetchStrategies.bobs;e.fetchData(e.props.model,getPaths(t,i),"titleCardEnter1",null,i.forceUpdate)}),this.queue(function(){var i=prefetchStrategies.jawBones,o=getPaths(t,i);e.fetchData(e.props.model,o,"titleCardEnter2",null,i.forceUpdate)}),this.fetchedBOBData=!0),this.props.aJawBoneOpen)this.jawBoneTimeout||this.props.myJawBoneOpen||(this.showHoverPulse=!0,this.jawBoneTimeout=setTimeout(function(){EventBus.emit("jawbone:open",_.assign({},e.context,e.props,{trigger:"miniBob"})),e.openJawBoneAtRankNum(e.props.rankNum,e.props.videoId),e.clearDelays()},DELAY_JAWBONE));else if(!this.bobTimeout){var i=this.props.getRowDidBob&&this.props.getRowDidBob()?BobCard.DELAY_OPEN_FAST:BobCard.DELAY_OPEN_SLOW;i===BobCard.DELAY_OPEN_SLOW&&(this.showHoverPulse=!0),this.bobTimeout=setTimeout(function(){e.isHovering&&e.isMounted()&&(EventBus.emit("bob:open",_.assign({},e.context,e.props,{matchScore:null})),e.setState({hasBob:!0}),EventBus.once("bob:open",function(t){var i=_.get(e.getData(),"summary.id",null),o=_.get(t,"videoId",null);i&&o&&i!==o&&e.handleLeave()})),e.clearDelays()},i)}},clearDelays:function(){clearTimeout(this.jawBoneTimeout),clearTimeout(this.bobTimeout),this.jawBoneTimeout=0,this.bobTimeout=0},handleLeave:function(){this.clearDelays();var e=this;this.state.hasBob&&-1===window.location.search.indexOf("stickybob")&&(EventBus.emit("bob:close",_.assign({},this.context,this.props)),this.props.onBobLeave(this.props.rankNum,function(){e.isMounted()&&e.setState({hasBob:!1})})),this.isHovering=!1},onBobOpenJaw:function(){this.onOpenJaw(!1)},onOpenJaw:function(e){this.handleLeave(),this.setState({hideJawFocus:!e,hasBob:!1})},componentDidMount:function(){if(this.motionBoxArtVideoId=this.getMotionVideoId(this.getVideoId(),this.props.listContext),this.motionBoxArtVideoId){var e=this;EventBus.emit("motion-boxart:register",{component:this,element:this.getDOMNode(),videoId:this.motionBoxArtVideoId,sortIndex:100*this.props.rowNum+this.props.rankNum,getVideo:function(){return e.isMounted()?e.refs.motion.getDOMNode():null}}),this.forceUpdate()}},componentWillUnmount:function(){this.clearDelays()},handleWindowVisibilityChange:function(e){e||this.handleLeave()},componentWillUpdate:function(e,t){t.hasBob&&!this.state.hasBob?EventBus.once("window-visibility:changed",this.handleWindowVisibilityChange):!t.hasBob&&this.state.hasBob&&EventBus.removeListener("window-visibility:changed",this.handleWindowVisibilityChange)},onBobOpen:function(e,t,i){this.props.onBobOpen&&this.props.sliderItemId&&this.props.onBobOpen(this.props.sliderItemId,e,t,i)},onBobClose:function(e,t){var i=this,o=function(){i.props.myJawBoneOpen&&i.setState({hideJawFocus:!1}),t&&t()};this.props.onBobClose&&this.props.sliderItemId&&this.props.onBobClose(this.props.sliderItemId,e,o)},getVideoId:function(){var e=this.props.model.getValueSync(["summary"]);return e&&e.id?e.id:0},getBoxArt:function(e){var t=e.getValueSync(["boxarts"]),i=TitleCard.extension(this.getContext());return t&&t[SIZE]&&t[SIZE][i]?t[SIZE][i].url:null},getTitle:function(e){return e&&e.getValueSync(["title"])},getWatchedEvidence:function(e){if(!e)return this.getString(BUNDLE,"evidence.continueWatching");var t={hour:36e5,day:864e5},i=new Date,o=i-e,n=parseInt(o/t.day,10);return o<t.day?this.getString(BUNDLE,"evidence.continueWatching"):this.getString(BUNDLE,"evidence.dayEvidence",{numDays:n})},getEvidence:function(e){var t=e&&e.getBoundValue(),i=t&&t.queue&&t.queue.inQueue,o=t&&t.playListEvidence,n=o&&o.name;return n?"galleryPlaylistVideo"===n&&i?this.getString(BUNDLE,"evidence.mylist"):"galleryContinueWatchingVideo"===n?e.getValueSync(["bookmark"])&&e.getValueSync(["bookmark"]).bookmarkLastModified?this.getWatchedEvidence(e.getValueSync(["bookmark"]).bookmarkLastModified):this.getString(BUNDLE,"evidence.continueWatching"):void 0:""},getData:function(){var e=this.props.model,t={model:e,summary:e.getValueSync(["summary"]),boxart:this.getBoxArt(e),title:this.getTitle(e)};return this.props.showVideoEvidence&&(t.evidence=this.getEvidence(e)),this.motionBoxArtVideoId&&(t.boxart=this.getMotionAsset("static",this.motionBoxArtVideoId)),t},getInnerContent:function(){return!this.motionBoxArtVideoId||this.props.aJawBoneOpen||this.state.hasBob?null:React.createElement(MotionBoxArt,{ref:"motion",videoId:this.motionBoxArtVideoId})},render:function(){var e,t=this.getData(),i=React.addons.classSet,o=i({smallTitleCard:!0,lockup:!0,title_card:!0,"pop-in":this.props.animateIn,highlighted:this.props.myJawBoneOpen,"not-highlighted":this.props.aJawBoneOpen&&!this.props.myJawBoneOpen,"hover-pulse":this.showHoverPulse}),n={};if(PathEvaluatorUtils.isValueError(t.summary))return React.createElement(ErrorTitleCard,{classes:o,errorMessage:t.summary.message});if(!t.summary||!t.boxart)return React.createElement(ErrorTitleCard,{classes:o,errorMessage:"Summary or boxart is undefined"});this.props.animateIn&&(e=t.summary.id%20*2.5/100+.3,n=CSSAnimation.getAnimationStyle({keyframes:{delay:e+"s"}}));var s="title-card-"+t.summary.id,a=this.props.myJawBoneOpen&&!this.state.hideJawFocus,r={backgroundImage:"url("+t.boxart+")"};return React.createElement("div",null,React.createElement("div",{id:s,key:s,className:o+" "+this.props.className,style:n,tabIndex:this.props.itemTabbable?0:null,"aria-label":t.title?t.title:null,role:"link",onMouseOver:this.handleMouseOver,onMouseOut:this.handleMouseOut,onClick:this.handleClick,onFocus:this.handleFocus,onBlur:this.handleBlur,onKeyDown:this.handleKeyDown},React.createElement(PresTrackedElement,{videoId:t.summary.id},React.createElement("div",{className:"video-artwork",style:r},this.getInnerContent())),a?React.createElement(TitleCardFocus,{model:t.model}):null,React.createElement(ReactTransitionGroup,null,this.state.hasBob?React.createElement(BobCard,{model:t.model,parentNode:this.getDOMNode(),titleArt:t.boxart,onBobOpen:this.onBobOpen,onBobClose:this.onBobClose,onJawOpen:this.onBobOpenJaw,videoId:this.props.videoId}):null)),this.props.showVideoEvidence?React.createElement("div",{className:"video-evidence"},t.evidence):null)}});module.exports=TitleCard;
...
Requireify.register('js/nanoPlayer/nanoCadmium.js', function(require, requireAsync, module, exports) {


"use strict";function NanoCadmium(o,t){this.el=o,this.config=t}var EventBus=require("../reactMixins/eventBus"),_=require("lodash");_.assign(NanoCadmium.prototype,EventBus),NanoCadmium.prototype.play=function(){},NanoCadmium.prototype.seek=function(){},NanoCadmium.prototype.request=function(){},NanoCadmium.prototype.load=function(){},NanoCadmium.prototype.shutdown=function(){},NanoCadmium.prototype.refresh=function(){},module.exports=NanoCadmium;
...
"use strict";function _useVideoTag(e){return!!e.videoSrc}var React=require("react"),NanoCadmium=require("./nanoCadmium"),_=require("lodash"),NanoPlayer=React.createClass({displayName:"NanoPlayer",statics:{VIDEO_REF:"video"},videoState:{stalled:!1,playing:!1},volume:function(e){return void 0===e?this.getNode().volume:(this.getNode().volume=e,e)},play:function(e){_useVideoTag(this.props.manifest)?this.getNode()[e?"play":"pause"]():this.nanoCad.play(e)},seek:function(e){_useVideoTag(this.props.manifest)?this.getNode().currentTime=e:this.nanoCad.seek(e)},getNode:function(){return this.refs[NanoPlayer.VIDEO_REF].getDOMNode()},onRebuffering:function(){this.videoState.stalled||(this.videoState.stalled=!0,this.props.onRebuffering&&this.props.onRebuffering())},onTimeUpdate:function(){var e=!1;this.videoState.stalled&&(this.videoState.stalled=!1,e=!0),this.videoState.playing||(e=this.videoState.playing=!0),e&&this.props.onPlaying&&this.props.onPlaying()},componentDidMount:function(){var e,o=this.getNode();_useVideoTag(this.props.manifest)?(e=document.createElement("source"),e.src=this.props.manifest.videoSrc,e.type=this.props.manifest.videoType,o.appendChild(e),o.addEventListener("canplaythrough",this.props.onLoaded||_.noop),o.addEventListener("ended",this.props.onEnd||_.noop),o.addEventListener("stalled",this.onRebuffering),o.addEventListener("timeupdate",this.onTimeUpdate),o.addEventListener("error",this.props.onError||_.noop)):(this.nanoCad=new NanoCadmium(o,this.props),this.nanoCad.on("loaded",this.props.onLoaded||_.noop),this.nanoCad.on("ended",this.props.onEnd||_.noop),this.nanoCad.on("busyChanged",this.onRebuffering),this.nanoCad.on("timeupdate",this.onTimeUpdate),this.nanoCad.on("error",this.props.onError||_.noop),this.props.elementProps.preload&&this.nanoCad.load(),this.props.elementProps.autoPlay&&this.nanoCad.play(!0))},componentWillUnmount:function(){var e;_useVideoTag(this.props.manifest)?(e=this.getNode(),e.removeEventListener("canplaythrough",this.props.onLoaded||_.noop),e.removeEventListener("ended",this.props.onEnd||_.noop),e.removeEventListener("stalled",this.onRebuffering),e.removeEventListener("timeupdate",this.onTimeUpdate),e.removeEventListener("error",this.props.onError||_.noop)):(this.nanoCad.removeListener("loaded",this.props.onLoaded||_.noop),this.nanoCad.removeListener("ended",this.props.onEnd||_.noop),this.nanoCad.removeListener("busyChanged",this.onRebuffering),this.nanoCad.removeListener("timeupdate",this.onTimeUpdate),this.nanoCad.removeListener("error",this.props.onError||_.noop),this.nanoCad.shutdown())},render:function(){return React.createElement("video",React.__spread({},this.props.elementProps,{ref:NanoPlayer.VIDEO_REF}))}});module.exports=NanoPlayer;
...
"use strict";var React=require("react"),_=require("lodash"),BillboardMotion=require("./billboardMotion.jsx"),MyListButton=require("../title/myListButton.jsx"),PlayButton=require("../controls/playbutton.jsx"),PlayLink=require("../controls/playLink.jsx"),PresTrackedContainer=require("../../../components/presentationTracking/presentationTrackingContainer.jsx"),PresTrackedElement=require("../../../components/presentationTracking/presentationTrackingElement.jsx"),I18N=require("../../../reactMixins/i18n"),IsomorphicContext=require("../../../reactMixins/isomorphicContextWithDeps"),Transition=require("../../../reactMixins/transition"),AB=require("../../../reactMixins/ab"),BillboardUtils=require("../../../utils/billboard"),BUNDLE="discovery/akira/Billboard:billboard.actions",FP_MOTION_BB_ENABLED="netflix.ui.akira.originals.billboard.motionEnabled",MOTION_HOLDBACK_TEST_ID=6583,BillboardOriginals=React.createClass({displayName:"BillboardOriginals",mixins:[I18N,IsomorphicContext,Transition,AB],statics:{pql:{},__meta__:{strings:[{bundle:BUNDLE,ids:["play","watchNow","watchEpisode","playSeason","playEpisode","playNextEpisode","rewatchShow","rewatchSeason","rewatchEpisode","continueWatching","continueSeason","playTrailer","playShowTrailer","playSeasonTrailer","playEpisodeTrailer","playRecap","playShowRecap","playSeasonRecap","playEpisodeRecap","info","playNewEpisodes"]}]},getPaths:function(e,a,t){return BillboardOriginals.pql={queue:["queue"]},[BillboardOriginals.pql.queue].concat(PlayButton.getPaths(e,a,t))}},transitions:{skipFirst:!0,fadeIn:500,fadeOut:500},logImpression:function(e){var a=this.props.model.getValueSync(),t=a.awardTrackId,i=a.billboardTheme;BillboardUtils.logImpression(e,a.id,t,i)},componentDidMount:function(){this.logImpression("impression")},recordAction:function(){this.logImpression("action")},renderActions:function(){var e=this,a=e.props,t=a.model.getValueSync(),i=a.videoModel.getValueSync("summary"),l=a.videoModel.getValueSync(BillboardOriginals.pql.queue)||{},o=[];return _.each(t.actions,function(t,l){var n="btn-flat"+(0===l?" btn-flat-primary":""),r=e.getString(BUNDLE,t.name,{sequenceNumber:t.sequenceNumber});"play"===t.type&&(i&&t.videoId===i.id?o.push(React.createElement(PlayButton,{key:l,className:n,annotation:r,model:a.videoModel,trackId:a.trackId,onClick:e.recordAction})):o.push(React.createElement(PlayLink,{key:l,className:n+" playLink",trackId:a.trackId,onClick:e.recordAction,videoId:t.videoId},React.createElement("div",{className:"playRing"},React.createElement("div",{className:"play icon-play"})),React.createElement("div",{className:"annotation"},r))))}),o.length<2&&o.push(React.createElement(MyListButton,{key:o.length,model:a.videoModel,videoId:t.id,inQueue:l.inQueue,onClick:e.recordAction})),React.createElement("div",{className:"billboard-links"},o)},render:function(){var e,a,t,i,l,o=this.props,n=o.model.getValueSync(),r=n.assets,s=r.background,c="light"===s.tone,d=this.isMotionBillboardEnabled(),m=!!n.motionUrl,p=!!n.isAward;return a=d&&m?[React.createElement(BillboardMotion,{videoId:n.id,motionId:n.motionId,videoBitrate:n.motionVideoBitrate,audioBitrate:n.motionAudioBitrate,key:"video",staticImageUrl:s.url,src:n.motionUrl})]:[React.createElement("img",{key:"hero",className:"hero",src:s.url}),React.createElement("div",{key:"vignette",className:"hero-vignette"})],t=r.logo?React.createElement("img",{className:"title-logo",src:r.logo.url,title:n.title}):React.createElement("div",{className:"title"},n.title),n.synopsis&&!p&&(i=React.createElement("div",{className:"synopsis"},n.synopsis)),n.supplementalMessage&&(l=React.createElement("div",{className:"supplemental"},n.supplementalMessage)),e=React.addons.classSet({billboard:!0,"billboard-pane":!0,"billboard-pane-main":!0,"billboard-originals":!0,"full-bleed-billboard":!0,"awards-billboard":p,"light-tone":c}),React.createElement("div",{className:e},a,React.createElement("div",{className:"info"},React.createElement(PresTrackedContainer,null,React.createElement("div",{className:"logo-and-text"},React.createElement(PresTrackedElement,{videoId:n.id},t,l,i)),this.renderActions())))},isMotionBillboardEnabled:function(){return this.ab().attr(MOTION_HOLDBACK_TEST_ID,"motionBillboardEnabled")!==!1&&this.getFastProperty(FP_MOTION_BB_ENABLED)}});module.exports=BillboardOriginals;
...
"use strict";var React=require("react"),Billboard=require("./billboard.jsx"),BillboardOriginals=require("./billboardOriginals.jsx"),PlayButton=require("../controls/playbutton.jsx"),ImageExtension=require("../../../common/imageExtension"),Position=require("../../../common/position"),IsomorphicContext=require("../../../reactMixins/isomorphicContextWithDeps"),AkiraContext=require("../../../reactMixins/akiraContext"),ScrollHorizontal=require("../../../reactMixins/scrollHorizontal.js"),EventBus=require("../../../reactMixins/eventBus"),AUTOCYCLE_INTERVAL_MS=1e4,AUTOCYCLE_SCROLL_POS=100,DIR_PREV=-1,DIR_NEXT=1,MAX_BILLBOARDS=5,BillboardRow=React.createClass({displayName:"BillboardRow",mixins:[IsomorphicContext,AkiraContext,ScrollHorizontal],wasClicked:!1,autoCycleId:0,ignoreMouseWheel:!1,ignoreMouseWheelTimeout:null,statics:{getPaths:function(t,e){var o=ImageExtension.getExtensionForTransparentImage(t),i=e.numBillboards||1,n=[["billboards",["length","trackIds"]],["billboards","billboardData",{to:i},o]],l=Billboard.getPaths(t).map(function(t){return["billboards",{to:i}].concat(t)}),a=BillboardOriginals.getPaths(t).map(function(t){return["billboards",{to:i}].concat(t)}),r=PlayButton.getPaths(t).map(function(t){return["billboards",{to:i}].concat(t)});return n.concat(l).concat(a).concat(r)},MAX_BILLBOARDS:MAX_BILLBOARDS},getInitialState:function(){var t=this.props.model.getValueSync(["length"]);return{billboardNum:0,numBillboards:t,disableNav:!1}},childContextTypes:{rowNum:React.PropTypes.number,rankNum:React.PropTypes.number,trackId:React.PropTypes.number},getChildContext:function(){return{rowNum:this.props.rowNum,rankNum:this.state.billboardNum,trackId:this.getTrackId()}},componentDidMount:function(){this.startAutoCycle(),window.addEventListener("blur",this.handleWindowBlur),window.addEventListener("focus",this.handleWindowFocus),EventBus.once("modal:open:welcomeModal",this.stopAutoCycle),EventBus.once("modal:open:paymentHoldModal",this.stopAutoCycle),EventBus.once("modal:close:welcomeModal",this.startAutoCycle),EventBus.once("modal:close:paymentHoldModal",this.startAutoCycle)},componentWillUnmount:function(){this.stopAutoCycle(),window.removeEventListener("blur",this.handleWindowBlur),window.removeEventListener("focus",this.handleWindowFocus),EventBus.removeListener("modal:open:welcomeModal",this.stopAutoCycle),EventBus.removeListener("modal:open:paymentHoldModal",this.stopAutoCycle),EventBus.removeListener("modal:close:welcomeModal",this.startAutoCycle),EventBus.removeListener("modal:close:paymentHoldModal",this.startAutoCycle)},handleWindowBlur:function(){this.isBlurred=!0},handleWindowFocus:function(){this.isBlurred=!1},handleClickArrow:function(t){this.switchBillboard(t)},handleClickDot:function(t){this.setBillboardNum(t)},handleMouseWheel:function(t){if(!(this.ignoreMouseWheel||this.state.numBillboards<=1)){var e=this.advanceDirection(t);"right"===e?this.switchBillboard(DIR_NEXT):"left"===e&&this.switchBillboard(DIR_PREV)}},switchBillboard:function(t){var e=this.state.billboardNum+t;0>e?e=this.state.numBillboards-1:e>this.state.numBillboards-1&&(e=0),this.ignoreMouseWheel=!0,clearTimeout(this.ignoreMouseWheelTimeout),this.ignoreMouseWheelTimeout=setTimeout(function(){this.ignoreMouseWheel=!1},500),this.setBillboardNum(e)},setBillboardNum:function(t){this.setState({billboardNum:t})},stopAutoCycle:function(){this.autoCycleId&&(clearInterval(this.autoCycleId),this.autoCycleId=0)},startAutoCycle:function(){clearInterval(this.autoCycleId),this.autoCycleId=setInterval(this.autoCycle,AUTOCYCLE_INTERVAL_MS)},autoCycle:function(){Position.getScrollTop()>=AUTOCYCLE_SCROLL_POS||this.isBlurred||this.switchBillboard(DIR_NEXT)},onSwitchPane:function(t){this.setState({disableNav:t})},getTrackId:function(){var t,e=this.props.model.getValueSync(["trackIds"]);return e&&(t=e.trackId),t},render:function(){var t,e=this.props.model.bind([this.state.billboardNum]),o=this.renderBillboardOriginals(),i=o&&o.isMotion?null:this.renderNavControls();return t=o?o.component:React.createElement(Billboard,{model:e,key:"bb-"+this.state.billboardNum,onSwitchPane:this.onSwitchPane}),React.createElement("div",{className:"billboard-row",onClick:this.stopAutoCycle,onMouseEnter:this.stopAutoCycle,onMouseLeave:this.startAutoCycle,onWheel:this.handleMouseWheel},i,t)},renderNavControls:function(){var t,e,o=[],i=this.state,n=i.billboardNum;if(i.disableNav||i.numBillboards<=1)return null;for(t=0;t<i.numBillboards;t++)e=React.addons.classSet({"nav-dot":!0,"icon-circle-solid":!0,"dot-active":t===n}),o.push(React.createElement("div",{key:"dot-"+t,className:e,onClick:this.handleClickDot.bind(this,t)}));return[React.createElement("div",{key:"left",className:"nav-layer nav-arrow nav-arrow-left icon-leftCaret",onClick:this.handleClickArrow.bind(this,DIR_PREV)}),React.createElement("div",{key:"right",className:"nav-layer nav-arrow nav-arrow-right icon-rightCaret",onClick:this.handleClickArrow.bind(this,DIR_NEXT)}),React.createElement("div",{key:"dots",className:"nav-layer nav-dots"},o)]},renderBillboardOriginals:function(){var t,e,o,i,n=this.state,l=this.props.model,a=n.billboardNum,r=n.numBillboards,s=!1,c=ImageExtension.getExtensionForTransparentImage(this.getContext());for(t=0;r>t;t++)if(o=l.bind(["billboardData",t,c]),i=o&&o.getValueSync(),i&&i.motionId){s=!0,e=l.bind([t]);break}return s||(o=l.bind(["billboardData",a,c]),i=o.getValueSync(),e=l.bind([a])),i&&i.isOriginal?{isMotion:s,component:React.createElement(BillboardOriginals,{model:o,videoModel:e,key:"bb-"+a,onSwitchPane:this.onSwitchPane})}:null}});module.exports=BillboardRow;
...
"use strict";var React=require("react"),LoadingTitle=require("./loadingTitle.jsx"),AkiraContext=require("../../../reactMixins/akiraContext"),NUM_LOADING_BOXES=24,LoadingGallery=React.createClass({displayName:"LoadingGallery",mixins:[AkiraContext],render:function(){var e,a=React.addons.classSet,t=[],n=[],o={rowContainer:!0},i="",r=0,l=this.context.columnsInRow||6,s={6:[0,1,2,4,2,4,3],5:[0,1,6,1,6,1,1],4:[0,1,4,1,6,0,1],3:[0,1,4,1,6,0,1],2:[0,1,4,1,6,0,1]},c=0,d=0;for(e=0;NUM_LOADING_BOXES>e;e++)d++===s[l][c]&&(i=2*Math.random()+e%6,c++,d=0,c>5&&(c=1)),t.push(React.createElement(LoadingTitle,{delay:i,pulsate:!d,displayWhenNotPulsing:!1,key:"loading-box-"+e})),e%this.context.columnsInRow===this.context.columnsInRow-1&&(n.push(React.createElement("div",{className:a(o),key:"loadingRow-"+r},t)),t=[],r++);return React.createElement("div",{key:"loading-boxes",className:"galleryLoader"},n)}});module.exports=LoadingGallery;
...
"use strict";var React=require("react"),_=require("lodash"),Scheduler=require("../../reactMixins/scheduler"),AutoFetch=require("../../reactMixins/falkor-auto-fetch"),Sortable=require("../../reactMixins/sortable"),BrowserScroll=require("../../reactMixins/browserScroll"),Prefetch=require("../../reactMixins/prefetchWithDeps"),NodeContext=require("../../reactMixins/nodecontext"),I18N=require("../../reactMixins/i18n"),EventBus=require("../../reactMixins/eventBus"),AkiraContext=require("../../reactMixins/akiraContext"),Position=require("../../common/position"),Row=require("../components/row.jsx"),TitleCard=require("../components/title/titleCard.jsx"),LoadingGallery=require("../components/loaders/loadingGallery.jsx"),LoadingSpinner=require("../components/loaders/loadingSpinner.jsx"),TimeoutTransitionGroup=require("../components/timeoutTransitionGroup.jsx"),PathEvaluatorUtils=require("../../utils/pathEvaluatorUtils"),INFINITE_SCROLL_BUFFER_PX=2e3,ADDITIONAL_FETCH_KEY="infinite-scroll-fetch-rows",ADDITIONAL_PAGE_LOAD_WAIT_MS=900,FADE_OUT_CONTENT_TIMEOUT_MS=550,FADE_IN_CONTENT_TIMEOUT_MS=250,BUNDLE="discovery/akira/Gallery",prefetchStrategies={minimum:{numVideos:0,bobs:!1,jawBones:!1},small:{numVideos:48,batchVideoSize:12,bobs:!1,jawBones:!1},medium:{numVideos:48,batchVideoSize:48,bobs:!1,jawBones:!1},maximum:{numVideos:5e3,batchVideoSize:150,bobs:!0,jawBones:!0}},defaultStrategy=prefetchStrategies.small,getPaths=function(e,t,r){t||(t=defaultStrategy),r||(r={});var s,i,o,n=r&&r.fromNum||0,a=r&&r.toNum||t.numVideos,l=r.sortOrder?[r.sortOrder,{from:n,to:a}]:[{from:n,to:a}],c=TitleCard.getPaths(e,t).map(function(e){return l.concat(e)}),u=[[["id","length","name","trackIds","requestId"]]];return u=u.concat(c),r.sortOrder===Sortable.ORDER_BY_MATURITY&&(s=l.concat("maturity"),u=u.concat([s])),r.sortOrder&&(i=[r.sortOrder,"requestId"],u=u.concat([i])),r.term&&(o=[[["referenceId"]]],u=u.concat(o)),u},GalleryContent=React.createClass({displayName:"GalleryContent",mixins:[AutoFetch,Sortable,BrowserScroll,NodeContext,Prefetch,I18N,AkiraContext],getInitialState:function(){return{fetchingMoreRows:!1}},numTitlesToFetch:defaultStrategy.numVideos,isFirstSetOfResults:!0,isInteractive:!1,statics:{getPaths:getPaths,defaultStrategy:defaultStrategy,prefetchStrategies:prefetchStrategies},childContextTypes:{requestId:React.PropTypes.string,trackId:React.PropTypes.number,jawBoneTrackId:React.PropTypes.number,jawBoneEpisodeTrackId:React.PropTypes.number,jawBoneTrailerTrackId:React.PropTypes.number},getChildContext:function(){var e=this.getTrackIds();return{requestId:this.getRequestId(),trackId:e.trackId,jawBoneTrackId:e.trackId_jaw,jawBoneEpisodeTrackId:e.trackId_jawEpisode,jawBoneTrailerTrackId:e.trackId_jawTrailer}},allRowsFetched:function(){var e=this.bindSortedModel();if(e){var t=!e.bind([this.numTitlesToFetch-1]).getValueSync("summary");return this.props.inLolomo&&t&&EventBus.emit("gallery:fetchedAllRows",{}),t}return EventBus.emit("gallery:fetchedAllRows",{}),!0},fetchMoreRows:function(e){var t,r,s=this.getStrategy("netflix.ui.akira.prefetch.galleryLoaded"),i=this.props.sortOrder===Sortable.ORDER_BY_MATURITY?prefetchStrategies.maximum.batchVideoSize:s.batchVideoSize,o=this.props.model;this.isLoading()||this.allRowsFetched()||(this.numTitlesToFetch+=i,this.isFirstSetOfResults=!1,t={sortOrder:this.props.sortOrder,toNum:this.numTitlesToFetch},r=getPaths(this.getContext(),s,t),this.isMounted()&&(e&&(this.setState({fetchingMoreRows:!0}),this.state.fetchingMoreRows=!1),this.fetchData(o,r,ADDITIONAL_FETCH_KEY)))},prefetchOnLoad:function(){this.isFirstSetOfResults&&Scheduler.queue(this.fetchMoreRows,ADDITIONAL_PAGE_LOAD_WAIT_MS)},onScroll:function(){this.isWithinDistanceBuffer(INFINITE_SCROLL_BUFFER_PX)&&this.fetchMoreRows(!0)},isWithinDistanceBuffer:function(e){var t=this.refs.gallery&&this.refs.gallery.getDOMNode(),r=!1;return t&&(r=Position.getDistanceToBottomOfElement(t)<e),r},getTrackIds:function(){var e=this.props.model,t=this.props.trackIds;return!t&&e.getValueSync(["trackIds"])&&(t=e.getValueSync(["trackIds"])),t||{}},getRequestId:function(){var e=this.props.model.getValueSync([this.props.sortOrder,"requestId"]),t=this.props.model.getValueSync(["requestId"]);return this.props.referenceId||e||t},shouldAnimateInTitle:function(){if(this.props.inLolomo)return!1;var e=["search"];return-1===e.indexOf(this.props.keyPrefix)&&this.isFirstSetOfResults},renderGallery:function(){var e,t,r,s=this.props.model.getValueSync(["id"]),i=this.bindSortedModel(),o=null,n=[],a=[],l=this.props.rowNum||0,c=0,u=0,d=0;for(t=0;t<this.numTitlesToFetch;t++)if(e=i.bind([t]),e.getBoundValue())r=e.getValueSync("summary"),r&&(!this.props.filter||this.props.filter(e))&&(this.props.jawBoneRowNum===l&&this.props.jawBoneRankNum===c&&(o=t),a.push(React.createElement(TitleCard,{key:"title_"+r.id+"_"+l+"_"+t,model:e,rankNum:c,videoId:r.id,showVideoEvidence:this.props.showVideoEvidence,animateIn:this.shouldAnimateInTitle()})),c++,u%this.context.columnsInRow===this.context.columnsInRow-1&&(n.push(this.renderRow(i,l,a,o)),l++,c=0,a=[]),u++);else if(d++,3===d)break;return a.length>0&&!this.props.inLolomo&&n.push(this.renderRow(i,l,a,o)),React.createElement("div",{key:"gallery-"+s,className:"galleryLockups"},n)},renderRow:function(e,t,r,s){var i=null,o=null,n=!1;return this.props.jawBoneRowNum!==t||_.isUndefined(s)||(i=this.props.jawBoneRankNum,o=s,n=!0),React.createElement(Row,{model:e,pqls:this.props.pqls,totalItems:r.length,key:"gallery-row-"+t,rowNum:t,jawBoneRankNum:i,jawBoneModelIndex:o,showJawBone:n,isGallery:!0},r)},renderNoResults:function(){return React.createElement("div",{className:"galleryMessage",key:"galleryMessage"},this.getString(BUNDLE,"results.none"))},renderError:function(){return React.createElement("div",{className:"galleryMessage",key:"galleryMessageError"},this.getString(BUNDLE,"results.error"))},componentWillReceiveProps:function(e){this.props.sortOrder!==e.sortOrder&&(this.numTitlesToFetch=defaultStrategy.numVideos,this.isFirstSetOfResults=!0)},setIsInteractive:function(){this.isLoading()||!this.isFirstSetOfResults||this.isInteractive||(EventBus.emit("app:interactive",this.props),this.isInteractive=!0)},componentDidMount:function(){this.prefetchOnLoad(),this.setIsInteractive()},componentDidUpdate:function(){this.prefetchOnLoad(),this.setIsInteractive()},render:function(){var e,t,r,s,i,o,n,a,l=React.addons.classSet,c=this.props.model.getValueSync(["name"]),u=this.bindSortedModel(),d=null,h=null;return e={gallery:!0,"row-with-x-columns":!0,search:"search"===this.props.keyPrefix&&!this.props.header,inLolomo:this.props.inLolomo},e["has-open-jaw"]=this.props.jawBoneVideoId,i=u.bind([0]).getValueSync("summary"),s=PathEvaluatorUtils.hasAnyError([c,i]),r=i&&!s,n=!this.props.inLolomo&&this.isLoading()&&this.isFirstSetOfResults,a=this.state.fetchingMoreRows&&!this.isFirstSetOfResults,"search"===this.props.keyPrefix&&this.props.onNoResults&&(o=this.props.onNoResults&&this.props.onNoResults()&&this.props.noResults),r?d=this.renderGallery():s?d=this.renderError():n?h=React.createElement(LoadingGallery,null):d=o?this.props.noResults():this.renderNoResults(),d=React.createElement("div",{key:"main-gallery"},d),r&&a&&(t=React.createElement("div",{className:"gallerySpinLoader"},React.createElement(LoadingSpinner,null))),React.createElement("div",{className:l(e),ref:"gallery"},this.props.header?this.props.header:React.createElement("div",{className:"title",dangerouslySetInnerHTML:{__html:c}}),React.createElement(TimeoutTransitionGroup,{className:"galleryContent",transitionName:"pulsateTransition",component:"div",enterTimeout:FADE_IN_CONTENT_TIMEOUT_MS,leaveTimeout:FADE_OUT_CONTENT_TIMEOUT_MS},h||d),t)}});GalleryContent.__meta__={strings:[{bundle:"discovery/akira/Gallery",ids:["results.none","results.error"]}]},module.exports=GalleryContent;
...
"use strict";var React=require("react"),AkiraContext=require("../../../reactMixins/akiraContext"),IsomorphicContext=require("../../../reactMixins/isomorphicContextWithDeps"),GalleryContent=require("../../layouts/gallery.jsx"),RowHeader=require("./rowHeader.jsx"),prefetchStrategies={galleryTest:{numBillboards:1,rowMin:0,numRows:1,numVideos:20,bobs:!1,jawBones:!1}},getPaths=function(e,t,r){var a=r&&void 0!==r.totalVideos?Math.min(t.numVideos,r.totalVideos):t.numVideos,o=t.startIndex||0,s=["galleryDisplayAsRow"];return s.concat([[{from:o,to:a},["playListEvidence","bookmark","queue"]]])},GalleryRow=React.createClass({displayName:"GalleryRow",statics:{getPaths:getPaths,prefetchStrategies:prefetchStrategies},mixins:[IsomorphicContext,AkiraContext],render:function(){var e=React.createElement(RowHeader,{title:this.props.model.getValueSync(["displayName"])});return React.createElement("div",{className:"galleryRow"},React.createElement(GalleryContent,React.__spread({model:this.props.model},this.props,{header:e,inLolomo:!0,showVideoEvidence:!0,pqls:GalleryContent.getPaths(this.getContext())})))}});module.exports=GalleryRow;
...
"use strict";var React=require("react"),LolomoRow=require("./lolomoRow.jsx"),BillboardRowResolver=require("../billboard/billboardRowResolver.jsx"),LoadingRow=require("../loaders/loadingRow.jsx"),cookieUtils=require("../../../utils/cookieUtils"),urls=require("../../../utils/urls"),pathEvaluatorUtils=require("../../../utils/pathEvaluatorUtils"),AkiraContext=require("../../../reactMixins/akiraContext"),IsomorphicContext=require("../../../reactMixins/isomorphicContextWithDeps"),AutoFetch=require("../../../reactMixins/falkor-auto-fetch"),EventBus=require("../../../reactMixins/eventBus"),FastProperty=require("../../../reactMixins/fastProperty"),MotionBoxArtTest=require("../../../reactMixins/ab/motionBoxArtTest"),MotionBoxArtController=require("./motionBoxArtController.jsx"),GalleryRow=require("./galleryRow.jsx"),SiteError=require("../../page/siteError.jsx"),MAX_ROWS=50,SUGGESTION_GALLERY_CONTEXT="suggestionsForYouGallery",SUGGESTION_ROW_CONTEXT="galleryDisplayAsRow",prefetchStrategies={allRows:{numRows:MAX_ROWS,numVideos:7,bobs:!1,jawBones:!1}},defaultStrategy=prefetchStrategies.allRows,getPaths=function(e,t){var o=["responseExpiration","statusCode"];t||(t=defaultStrategy);var r={from:t.rowMin||0,to:t.numRows},s=LolomoRow.getPaths(e,t).map(function(e){return[r].concat(e)}).concat([[r,"context"]]).concat([["summary"]]).concat([["meta",o]]).concat([["requestId"]]);if(r&&0===r.from){var i=GalleryRow.getPaths(e,t).map(function(e){return[{from:0,to:1}].concat(e)});return s.concat(i)}return s},Lolomo=React.createClass({displayName:"Lolomo",mixins:[AutoFetch,IsomorphicContext,AkiraContext,FastProperty,MotionBoxArtTest],statics:{getPaths:getPaths,prefetchStrategies:prefetchStrategies,MAX_ROWS:MAX_ROWS},childContextTypes:{requestId:React.PropTypes.string},getChildContext:function(){return{requestId:this.getRequestId()}},getInitialState:function(){return{bouncing:!1}},allRowsPQLS:function(){return getPaths(this.getContext(),prefetchStrategies.allRows)},getRequestId:function(){return this.props.model.getValueSync(["requestId"])},seedLolomoImpression:function(){var e=this.getFeatureData("userInfo").lolomoCookieName;if(e){var t,o,r,s=cookieUtils.get(e),i=window&&window.pathEvaluator||!1,n=this.getFeatureData("geo").preferredLocale.country;s&&i&&(t=s.split(":"),o=t[0],r=t[1],n===o&&(i.setValueSync(["lolomo"],["lolomos",r]),i.setValueSync(["lolomos",r,"aLeafNode"],"anyValue")))}},prepareForAutoFetch:function(){if(!this.props.suppressBillboard){var e=this.props.model;e.getBoundValue()||this.seedLolomoImpression()}},lolomoIsValid:function(){var e=this.props.model,t=e.getBoundValue(),o=!!t&&"error"!==t.$type;return o&&this.hasFirstRow()},getNumRows:function(){var e,t=this.props.model,o=-1;if(!t.getBoundValue())return-1;if(this.props.newArrivals===!0)o=t.getValueSync(["length"]);else{if(e=t.getValueSync(["summary"]),!e)return-1;o=e.length}return o},allRowsFetched:function(){var e,t=this.props.model,o=this.getNumRows();if(0>o)return!1;for(e=0;o>e;e++)if(!t.bind([e]).getBoundValue())return!1;return!0},renderPlaceHolder:function(){return React.createElement(LoadingRow,{pulsateTitles:!0,pulsateHeader:!1,showSpinner:!1})},renderSiteError:function(){return React.createElement(SiteError,null)},setIsInteractive:function(){this.isLoading()||this.isInteractive||(EventBus.emit("app:interactive",this.props),this.isInteractive=!0)},bounceLolomo:function(){var e=this.getFeatureData("userInfo").lolomoCookieName;cookieUtils.clear(e),setTimeout(function(){document.location.href=urls.page.app},10)},componentDidMount:function(){var e=this;this.setIsInteractive(),this.once("auto-fetch-done",function(t){if("timeout"===t||!this.lolomoIsValid()){var o=this.getFeatureData("userInfo").lolomoCookieName;if(o){var r=cookieUtils.get(o);if(r)return e.setState({bouncing:!0}),e.bounceLolomo(),void 0}this.isMounted()&&this.forceUpdate()}})},componentDidUpdate:function(){this.setIsInteractive()},renderLolomo:function(){for(var e,t,o,r,s,i,n,a=React.addons.classSet,l=!0,u=!1,c=[],h=0,d=0,p=null,m=BillboardRowResolver.resolve(this.getContext());l;){if(l=this.hasNthRow(h)){if(e=this.props.model.bind([h]),t=e.getValueSync(["context"]),i=t===SUGGESTION_GALLERY_CONTEXT&&!e.getValueSync([SUGGESTION_ROW_CONTEXT]),i&&(n=e.getValueSync(["length"]),d=Math.floor(n/this.context.columnsInRow-1)),this.props.jawBoneRowNum===h+d||i&&this.props.jawBoneRowNum<=h+d?(p=this.props.jawBoneRankNum,r=!0,o=this.props.jawBoneVideoId):(p=null,r=!1,o=null),this.props.suppressBillboard&&"billboard"===t||"socialPopular"===t||"rateMovies"===t){h++;continue}"billboard"===t&&(c.push(React.createElement(m,{model:e,rowNum:h,key:h})),u=!0),i?c.push(React.createElement(GalleryRow,React.__spread({ref:"galleryRow"},this.props,{model:e,rowNum:h,key:h,showJawBone:r,jawBoneRankNum:p,jawBoneVideoId:o}))):c.push(React.createElement(LolomoRow,{key:h+d,model:e,listContext:t,rowNum:h+d,showJawBone:r,jawBoneRankNum:p,showVideoEvidence:"suggestionsForYouGallery"===t,columnsInRow:this.context.columnsInRow}))}h++}return s={lolomo:!0,"is-fullbleed":u,"has-open-jaw":this.props.jawBoneVideoId},React.createElement("div",{className:a(s),ref:"lolomo"},this.hasMotionBoxArt()?React.createElement(MotionBoxArtController,null):null,c,this.isLoading()||this.allRowsFetched()?null:this.renderPlaceHolder())},hasFirstRow:function(){return this.hasNthRow(0)},hasNthRow:function(e){var t=this.props.model.bind([e]),o=t.getBoundValue();return!!o&&!pathEvaluatorUtils.isValueError(o)},getNthRow:function(e){return this.hasNthRow(e)?this.props.model.bind([e]):null},hasGalleryLolomo:function(){var e=[0,1],t=this;return e.forEach(function(e){return t.hasNthRow(e)&&t.getNthRow(e).getValueSync(["context"])===SUGGESTION_GALLERY_CONTEXT?!0:void 0}),!1},render:function(){return this.isAutoLoading()&&!this.hasFirstRow()?this.renderPlaceHolder():this.state.bouncing?null:this.lolomoIsValid()?this.renderLolomo():this.renderSiteError()}});module.exports=Lolomo;
...
"use strict";var React=require("react"),Lolomo=require("../components/lolomo/lolomo.jsx"),TitleCard=require("../components/title/titleCard.jsx"),BillboardRowResolver=require("../components/billboard/billboardRowResolver.jsx"),AB=require("../../reactMixins/abWithDeps"),FalkorFetch=require("../../reactMixins/falkor-fetch"),Prefetch=require("../../reactMixins/prefetchWithDeps"),Scheduler=require("../../reactMixins/scheduler"),FastProperty=require("../../reactMixins/fastProperty"),EventBus=require("../../reactMixins/eventBus"),PrefetchStrategy=require("../../falkorClient/prefetchStrategy"),ardbeg=require("nf-ardbeg"),contextData=require("../../utils/contextData"),MAX_BILLBOARDS=5,GALLERY_TEST_ID="6454",prefetchStrategies={minimum:{numBillboards:0,numRows:0,numVideos:0,bobs:!1,jawBones:!1},small:{numBillboards:1,numRows:3,numVideos:7,bobs:!1,jawBones:!1},medium:{numBillboards:MAX_BILLBOARDS,numRows:3,numVideos:19,bobs:!0,jawBones:!1},firstClient:{numBillboards:0,rowMin:4,numRows:7,numVideos:7,bobs:!1,jawBones:!1},secondClient:{numBillboards:0,rowMin:8,numRows:11,numVideos:7,bobs:!1,jawBones:!1},thirdClient:{numBillboards:0,rowMin:12,numRows:16,numVideos:7,bobs:!1,jawBones:!1},fourthClient:{numBillboards:0,rowMin:17,numRows:24,numVideos:7,bobs:!1,jawBones:!1},fifthClient:{numBillboards:0,rowMin:25,numRows:Lolomo.MAX_ROWS,numVideos:7,bobs:!1,jawBones:!1},maximum:{numBillboards:5,numRows:Lolomo.MAX_ROWS,numVideos:100,bobs:!0,jawBones:!0},galleryTest:{numBillboards:1,numRows:1,numVideos:20,bobs:!1,jawBones:!1}},defaultStrategy=prefetchStrategies.small,lastAdditionalFetchRowMin=prefetchStrategies.fifthClient.rowMin,FIRST_CHUNK_LOAD_INTERVAL_MS=50,CHUNK_LOAD_INTERVAL_MS=750,getPaths=function(e,t){t||(t=defaultStrategy);var o,a=t.numVideos,s=a,i=BillboardRowResolver.resolve(e);return o=[["summary"]].concat(Lolomo.getPaths(e,t)).concat(i.getPaths(e,t)).concat([["mylist","summary"]]).concat(TitleCard.getPaths(e,t).map(function(e){return["mylist",{to:s}].concat(e)}))},inGalleryRowTest=function(e){var t,o,a;return t="undefined"==typeof window?e.ab:ardbeg.evaluate(contextData.getData("ab","serializedAB")),o=t&&t._evaluatedTests,a=o&&o[GALLERY_TEST_ID],a&&a.attrs.displayAsGallery},getInitialPaths=function(e){var t=PrefetchStrategy.getStrategy("netflix.ui.akira.prefetch.page",e);return inGalleryRowTest(e)&&(t=PrefetchStrategy.getStrategy("netflix.ui.akira.prefetch.lolomoGallery",e)),getPaths(e,t)},HomeContent=React.createClass({displayName:"HomeContent",mixins:[AB,FalkorFetch,Prefetch,Scheduler,FastProperty],statics:{NUM_ROWS_TO_RENDER:15,NUM_TITLES_TO_RENDER:20,getPaths:getPaths,prefetchStrategies:prefetchStrategies,defaultStrategy:defaultStrategy,getInitialPaths:getInitialPaths,inGalleryRowTest:inGalleryRowTest},prefetchCallbacks:[],componentDidMount:function(){var e=this.refs.lolomo;this.ab().attr(GALLERY_TEST_ID,"displayAsGallery")&&e.hasGalleryLolomo()?EventBus.once("gallery:fetchedAllRows",this.loadAdditionalLolomoData):e.isLoading()?e.once("dataFetch:complete",this.loadAdditionalLolomoData):this.loadAdditionalLolomoData()},componentWillUnmount:function(){for(var e=this.prefetchCallbacks.pop();e;)this.cancelQueuedItem(e),e=this.prefetchCallbacks.pop();EventBus.removeListener("gallery:fetchedAllRows",this.loadAdditionalLolomoData)},loadAdditionalLolomoData:function(){if(!this.getRootModel().bind([lastAdditionalFetchRowMin]).getBoundValue()){var e=this,t=this.props.suppressBillboard?"lolomonobillboard":"lolomo",o=this.props.model.pathEvaluator.bind([t]),a="netflix.ui.akira.prefetch.homeLoaded",s=[null,a,a+".2",a+".3",a+".4",a+".5",a+".6"],i=function(t){if(o&&o.getBoundValue()){var a=e.getStrategy(t),s=getPaths(e.getContext(),a);e.fetchData(o,s,t,null,a.forceUpdate)}},l=parseInt(this.fastProperty("netflix.ui.lolomo.firstChunkLoadIntervalMS"),10)||FIRST_CHUNK_LOAD_INTERVAL_MS,r=parseInt(this.fastProperty("netflix.ui.lolomo.chunkLoadIntervalMS"),10)||CHUNK_LOAD_INTERVAL_MS;this.prefetchCallbacks.push(this.queue(function(){i(s[1])},l)),this.prefetchCallbacks.push(this.queue(function(){i(s[2])},l+1*r)),this.prefetchCallbacks.push(this.queue(function(){i(s[3])},l+2*r)),this.prefetchCallbacks.push(this.queue(function(){i(s[4])},l+3*r)),this.prefetchCallbacks.push(this.queue(function(){i(s[5])},l+4*r)),this.prefetchCallbacks.push(this.queue(function(){i(s[6])},l+5*r))}},getRootModel:function(){var e=this.props.suppressBillboard?"lolomonobillboard":"lolomo";return this.props.model.pathEvaluator.bind([e])},render:function(){var e=this.getRootModel(),t=HomeContent.NUM_ROWS_TO_RENDER,o=getInitialPaths(this.getContext(),this.nodeRequest());return React.createElement(Lolomo,{ref:"lolomo",model:e,pqls:o,numRows:t,jawBoneRankNum:this.props.jawBoneRankNum,jawBoneRowNum:this.props.jawBoneRowNum,jawBoneVideoId:this.props.jawBoneVideoId,suppressBillboard:this.props.suppressBillboard})}});module.exports=HomeContent;
...
"use strict";var cookieUtils=require("../cookieUtils"),HomeContent=require("../../akira/page/home.jsx"),EventBus=require("../../reactMixins/eventBus.js"),context=require("../contextData"),urls=require("../urls"),lolomoUtils=require("./lolomoUtils"),_=require("lodash");module.exports={refreshLolomo:function(e){this.evictLolomo(e),this.fetchLolomo(e)},evictLolomo:function(e){var o=context.getFeatureData("userInfo").lastLolomoImpressionKey;window.pathEvaluator.invalidate(["lolomo"],["lolomonobillboard"]).subscribe(),o&&cookieUtils.clear(o,context.getFeatureData("serverDefs").host||cookieUtils.TOP_DOMAIN,cookieUtils.ROOT_PATH),EventBus.emit("lolomo:refreshStart",{message:e})},fetchLolomo:function(e){var o=HomeContent.getInitialPaths(context.getContext()),t=window.pathEvaluator.bind(["lolomo"]);t.get.apply(t,o).subscribe(_.noop,function(){EventBus.emit("lolomo:refreshEnd",{success:!1,reason:"networkError",message:e})},function(){var o=context.getFeatureData("userInfo").lastLolomoImpressionTtl,s=lolomoUtils.generateHpMapRequestId(context.getFeatureData("userContext").lolomoCookiePrefix,urls.paths.app,context.getFeatureData("userInfo").guid),l=lolomoUtils.getLolomoCookieValue(window.pathEvaluator.getValueSync(["lolomo"]),context.getFeatureData("geo").preferredLocale.country,context.getFeatureData("geo").preferredLocale.id);lolomoUtils.isLolomoCookieValueValid(l)?(cookieUtils.set(s,l,lolomoUtils.getLolomoExpiry(t,o).expiry,context.getFeatureData("serverDefs").host||cookieUtils.TOP_DOMAIN,cookieUtils.ROOT_PATH),EventBus.emit("lolomo:refreshEnd",{success:!0,message:e})):EventBus.emit("lolomo:refreshEnd",{success:!1,reason:"invalidCookie",message:e})})}};
...
"use strict";var React=require("react"),ProfileChoices=require("./profileChoices.jsx"),ProfileLoad=require("./profileLoad.jsx"),ProfileCreate=require("./profileCreate.jsx"),FalkorFetch=require("../../../reactMixins/falkor-fetch"),ProfileManager=require("../../../utils/profileManager"),DynamicMessages=require("../../../utils/dynamicMessages/dynamicMessages"),AVATAR_WIDTH=320,MAX_PROFILE_COUNT=5,ProfilesGate=React.createClass({displayName:"ProfilesGate",mixins:[FalkorFetch],statics:{getPaths:function(){return[["profilesList","summary"],["profilesList",{to:MAX_PROFILE_COUNT},"summary"],["profilesList",{to:MAX_PROFILE_COUNT},"avatar","images","byWidth",AVATAR_WIDTH]]}},getInitialState:function(){return{animateSwitchingProfilesComplete:!1}},onSuccessAddProfile:function(){ProfileManager.setActiveView(ProfileManager.VIEWS.RELOADING_PROFILES),this.props.refetchPageChromeData(function(){ProfileManager.openProfileList()})},componentDidMount:function(){DynamicMessages.stub||DynamicMessages.poll(DynamicMessages.pollingTypes.PROFILESGATE).subscribe()},componentWillUnmount:function(){DynamicMessages.stub||DynamicMessages.stop()},renderProfileList:function(){var e=this.props.model.bind(["profilesList"]);return React.createElement(ProfileChoices,{key:"listProfile",model:e})},renderProfileLoading:function(e){return React.createElement(ProfileLoad,{key:"loadProfile",newProfile:this.props.newProfile,errorLoadingProfile:e})},renderProfileCreate:function(){return React.createElement(ProfileCreate,{key:"createProfile",onSuccessAddProfile:this.onSuccessAddProfile})},render:function(){var e=this.props.model.bind(["profilesList"]),r=e.getValueSync(["summary"]),i=this.props,t=i.activeView,o=t===ProfileManager.VIEWS.LOAD_PROFILE_ERROR,s=null;return r&&r.length?(t===ProfileManager.VIEWS.LIST?s=this.renderProfileList():t===ProfileManager.VIEWS.LOAD_PROFILE||o?s=this.renderProfileLoading(o):t===ProfileManager.VIEWS.CREATE_PROFILE&&(s=this.renderProfileCreate()),React.createElement("div",{className:"profiles-gate-container"},s)):null}});module.exports=ProfilesGate;
...
"use strict";var React=require("react"),Router=require("react-router"),_=require("lodash"),iframeCommunicator=require("../../common/iframeCommunicator"),Uma=require("../../components/uma.jsx"),Header=require("../components/header/appHeader.jsx"),Footer=require("../components/footer/appFooter.jsx"),ProfilesGate=require("../components/profile/profilesGate.jsx"),SatisfactionSurvey=require("../components/modals/satisfactionSurvey.jsx"),TimeoutTransitionGroup=require("../components/timeoutTransitionGroup.jsx"),I18N=require("../../reactMixins/i18nWithDeps"),FalkorFetch=require("../../reactMixins/falkor-fetch"),BrowserScroll=require("../../reactMixins/browserScroll"),EventBus=require("../../reactMixins/eventBus"),FastProperty=require("../../reactMixins/fastProperty"),ColumnsInRow=require("../../reactMixins/columnsInRow"),BrowserVisibility=require("../../reactMixins/browserVisibility"),ProfileManager=require("../../utils/profileManager"),PathEvaluatorUtils=require("../../utils/pathEvaluatorUtils"),Cookies=require("../../reactMixins/isomorphicCookies"),ON_SCROLL_STOP_HOVERS_THRESHOLD_PX=50,PAGE_TRANSITION_ENTER_SLA_MS=200,PAGE_TRANSITION_ENTER_DELAY_MS=250,PAGE_TRANSITION_LEAVE_SLA_MS=200,ENABLE_POINTER_EVENTS_DELAY=100,MYLIST_SORTSETTING_PATH=[["profilesList","current","usesManualMyListSort"]],AkiraLayout=React.createClass({displayName:"AkiraLayout",mixins:[I18N,FalkorFetch,BrowserScroll,Router.State,Router.Navigation,FastProperty,ColumnsInRow,Cookies,BrowserVisibility],childContextTypes:{node:React.PropTypes.object,jsongDocument:React.PropTypes.object,columnsInRow:React.PropTypes.number,currentPage:React.PropTypes.string},getChildContext:function(){return{node:this.props.model.node,jsongDocument:this.props.model.pathEvaluator,columnsInRow:this.state.columnsInRow,currentPage:this.props.uiView}},getInitialState:function(){var e=this.getFeatureData("umaData")||null;return{uma:e&&e.uma,modalOverlay:null}},componentWillMount:function(){"client"===this.props.renderSource&&this.logPageChange()},componentDidMount:function(){this.prefetchPageData(),this.checkForSurveyOverlay(),this.sendAdTech()},componentDidUpdate:function(){this.logPageChange()},afterPageTransitionLeave:function(){this.scrollTo(0,0)},onScroll:function(){var e=document.body.style;Math.abs(this.getScrollDistance())>ON_SCROLL_STOP_HOVERS_THRESHOLD_PX&&"none"!==e.pointerEvents&&(e.pointerEvents="none")},onScrollEnd:function(){setTimeout(function(){document.body.style.pointerEvents=""},ENABLE_POINTER_EVENTS_DELAY)},logPageChange:function(){var e=this.getPageProps(),t=this.props.profileGateAppState;e.uiView=ProfileManager.isGateOpen(t)?ProfileManager.getCurrentUIView(t):this.props.uiView,e.uiView&&EventBus.emit("app:pageChange",e)},prefetchPageData:function(){var e=this;if(this.isShowingProfilesGate()){var t=this.getFeatureData("postGateData");t&&t.length>0&&(e.state.prefetchPageDone=!1,this.fetchData(this.props.model.pathEvaluator,t,"prefetch-page",function(){e.state.prefetchPageDone=!0}))}},refetchPageChromeData:function(e){PathEvaluatorUtils.resetCache(this.props.model.pathEvaluator);var t=Header.getPaths(null,Header.fullHeaderStrategy).concat(MYLIST_SORTSETTING_PATH).concat(ProfilesGate.getPaths());this.fetchData(this.props.model.pathEvaluator,t,null,e,!1)},isShowingProfilesGate:function(){var e=this.props.model.pathEvaluator.bind(["profilesList"]),t=e.getValueSync(["summary"]),a=t&&t.length>0,r=this.props.profileGateAppState;return ProfileManager.isGateOpen(r)&&(a||ProfileManager.isReloadingProfiles(r))},isShowingUMA:function(){return!this.isShowingProfilesGate()&&this.state.uma},hideUMA:function(){this.setState({uma:null})},getPageKey:function(){var e=this.getPathname();return-1!==this.props.uiView.indexOf("search")&&(e="search"),e},getPageProps:function(){var e=this.getQuery();return{id:this.getParams().id,jawBoneRankNum:"undefined"!=typeof e.jbp?parseInt(e.jbp,10):null,jawBoneRowNum:"undefined"!=typeof e.jbr?parseInt(e.jbr,10):null,jawBoneVideoId:e.jbv}},showOverlay:function(e){this.setState({modalOverlay:e})},closeOverlay:function(){this.setState({modalOverlay:null})},checkForSurveyOverlay:function(){var e=this,t=this.props.model.pathEvaluator,a=["messaging","satisfactionSurvey"];this.fastProperty("netflix.ui.akira.satisfactionSurvey.disable")||this.fetchData(t,a.concat("messages"),"satisfactionSurvey",function(){var r=t.getValueSync(a.concat("messages"));r&&r.messageId&&(t.get(a.concat("markAsRead")).subscribe(function(){}),e.showOverlay("satisfactionSurvey"),SatisfactionSurvey.onClose(function(){e.closeOverlay()}))})},sendAdTech:function(){if(this.fastProperty("ui.iframeCommunicator.isActive")){var e=this.getFeatureData("geo"),t=_.get(window,"netflix.clientNotifications.getCurrentSession",function(){return{}})("userSession"),a=this.getQuery(),r=this.cookies(),i={referrer:"homeScreen",is_member:"current",session:t.sessionId,country:_.get(e,"preferredLocale.country","")},o={mqso:r.get("mqso"),nan_pid:a.nan_pid,utm_campaign:a.utm_campaign,movie_id:this.isActive("title")&&this.getParams().id};_.assign(i,_.omit(o,_.isUndefined));var n=this.fastProperty("ui.iframeCommunicator.locations.adTech");iframeCommunicator.send(n,i)}},renderUMA:function(){return React.createElement("div",{className:"uma",id:"uma",key:"uma-area"},React.createElement(Uma,{key:"user-uma",model:this.state.uma,hideUma:this.hideUMA}))},renderProfilesGate:function(){var e=this.props.profileGateAppState;return React.createElement(ProfilesGate,{model:this.props.model.pathEvaluator,activeView:e.activeView,newProfile:e.newProfile,refetchPageChromeData:this.refetchPageChromeData})},renderInnerView:function(){var e=this.getPageProps();return["satisfactionSurvey"===this.state.modalOverlay?React.createElement(SatisfactionSurvey,null):null,React.createElement(TimeoutTransitionGroup,{key:"mainView",className:"mainView",component:"div",transitionName:"pageTransition",enterTimeout:PAGE_TRANSITION_ENTER_SLA_MS,leaveTimeout:PAGE_TRANSITION_LEAVE_SLA_MS,enterDelayMs:PAGE_TRANSITION_ENTER_DELAY_MS,afterTransitionLeave:this.afterPageTransitionLeave},React.createElement(Router.RouteHandler,React.__spread({},this.props,{key:this.getPageKey(),jawBoneRankNum:e.jawBoneRankNum,jawBoneRowNum:e.jawBoneRowNum,jawBoneVideoId:e.jawBoneVideoId}))),React.createElement(Footer,{key:"footer"})]},render:function(){var e=this.props.model,t=this.getParams().term||"",a=t&&decodeURIComponent(t),r=this.isShowingProfilesGate(),i=this.isShowingUMA(),o=!i,n=this.getFeatureData("geo"),s=_.get(n,"preferredLocale.language","en");return React.createElement("div",{className:"bd dark-background",lang:s,onClick:this.handleClick,onChange:this.handleChange,onMouseMove:this.handleMouseMove},i?this.renderUMA():null,React.createElement(Header,{model:e,ref:"header",pathEvaluator:e.pathEvaluator,term:a,isShowingProfilesGate:r,pinned:o}),r?this.renderProfilesGate():this.renderInnerView(),React.createElement("div",{className:"image-preloaders"},React.createElement("span",{className:"jawbone-images"})))}});module.exports=AkiraLayout;
...
"use strict";module.exports={openJawParams:null,currentTab:null,isJawOpen:function(){return!!this.openJawParams},setOpenJawParams:function(a){this.openJawParams=a},getOpenJawParams:function(){return this.openJawParams},getCurrentTab:function(){return this.currentTab},setCurrentTab:function(a){this.currentTab=a},logJawOpen:function(a){var e=this;this.validateParamsAndSend({name:"logJawOpen",params:a,defaultParams:{view:"movieDetails",tab:"overview"},requiredParams:["trigger","videoId","rowNum","rankNum"],send:function(a){e.setOpenJawParams(a),e.logSessionStart("jawImpression",{category:"uiView",modalView:e.getCurrentModalView(),data:{view:a.view,trigger:a.trigger,jawTab:a.tab,matchScore:a.matchScore},dataContext:{trackId:a.trackId,videoId:a.videoId,row:a.rowNum,rank:a.rankNum,requestId:a.requestId}})}})},logJawClose:function(a){var e=this;this.validateParamsAndSend({name:"logJawClose",params:a,defaultParams:this.getOpenJawParams(),requiredParams:["reason","videoId","rowNum","rankNum"],send:function(a){e.logSessionEnd("jawImpression",{category:"uiView",modalView:e.getCurrentModalView(),data:{view:a.view,trigger:a.trigger,reason:a.reason},dataContext:{trackId:a.trackId,videoId:a.videoId,row:a.rowNum,rank:a.rankNum,requestId:a.requestId}}),e.setOpenJawParams(null)}})},logJawTabOpen:function(a){var e=this;this.validateParamsAndSend({name:"logJawTabSessionStarted",params:a,defaultParams:{view:"Overview"},requiredParams:["tab"],send:function(a){e.setCurrentTab(a.tab),e.logSessionStart("jawTabImpression",{category:"uiView",modalView:e.getCurrentModalView(),data:{jawTab:a.tab}})}})},logJawTabClose:function(a){var e=this;this.validateParamsAndSend({name:"logJawTabSessionEnded",params:a,defaultParams:{view:"Overview"},requiredParams:["tab"],send:function(a){e.setCurrentTab(a.tab),e.logSessionEnd("jawTabImpression",{category:"uiView",modalView:e.getCurrentModalView(),data:{jawTab:a.tab}})}})},logJawScrollLeft:function(a){var e=this;this.validateParamsAndSend({name:"logJawNavLeft",params:a,defaultParams:{},requiredParams:[],send:function(){e.logEvent("logJawNavLeft",{category:"uiView",modalView:e.getCurrentModalView(),data:{}})}})},logJawScrollRight:function(a){var e=this;this.validateParamsAndSend({name:"logJawNavRight",params:a,defaultParams:{},requiredParams:[],send:function(){e.logEvent("logJawNavRight",{category:"uiView",modalView:e.getCurrentModalView(),data:{}})}})},logJawTabClick:function(a){var e=this;this.validateParamsAndSend({name:"logJawClick",params:a,defaultParams:{tab:"Overview",name:"",url:"",type:""},requiredParams:["tab"],send:function(a){e.logEvent("logJawClick",{category:"uiView",modalView:e.getCurrentModalView(),data:{tab:a.tab,name:a.name,url:a.url,type:a.type}})}})}};
...
"use strict";module.exports={openBobParams:null,isBobOpen:function(){return!!this.openBobParams},setOpenBobParams:function(e){this.openBobParams=e},getOpenBobParams:function(){return this.openBobParams},logBobOpen:function(e){var a=this;this.validateParamsAndSend({name:"logBobOpen",params:e,defaultParams:{view:"bob"},requiredParams:["videoId","rowNum","rankNum"],send:function(e){a.setOpenBobParams(e),a.logSessionStart("impression",{category:"uiView",modalView:a.getCurrentModalView(),data:{view:e.view,matchScore:e.matchScore},dataContext:{trackId:e.trackId,videoId:e.videoId,row:e.rowNum,rank:e.rankNum,requestId:e.requestId}})}})},logBobClose:function(e){var a=this;this.validateParamsAndSend({name:"logBobClose",params:e,defaultParams:this.getOpenBobParams(),requiredParams:["videoId","rowNum","rankNum"],send:function(e){a.logSessionEnd("impression",{category:"uiView",modalView:a.getCurrentModalView(),data:{view:e.view},dataContext:{trackId:e.trackId,videoId:e.videoId,row:e.rowNum,rank:e.rankNum,requestId:e.requestId}}),a.setOpenBobParams(null)}})}};
...
"use strict";module.exports={logRating:function(a){var t=this;t.validateParamsAndSend({name:"logRating",params:a,requiredParams:["rating","videoId"],send:function(a){var e={category:"uiAction",modalView:t.getCurrentModalView(),data:{rating:a.rating,ratingType:a.ratingType,rankTitle:a.rankTitle,matchScore:a.matchScore},dataContext:{trackId:a.trackId,videoId:a.videoId,row:a.rowNum,rank:a.rankNum,requestId:a.requestId}};t.logSessionStart("rateTitle",e),t.logSessionEnd("rateTitle",e)}})}};
...
"use strict";module.exports={logPerformanceMetrics:function(a){var e=this;e.validateParamsAndSend({name:"logBrowsePlaybackPerformance",params:a,requiredParams:["playbackType"],send:function(a){var r={category:"www",modalView:e.getCurrentModalView(),data:a,dataContext:{}};e.logSessionStart("browsePlaybackPerformance",r),e.logSessionEnd("browsePlaybackPerformance",r)}})}};
...
"use strict";function initConsolidatedLogging(e){ConsolidatedLogging.setCurrentModalView(e),ConsolidatedLogging.attachListeners()}var React=require("react"),Router=require("react-router"),_=require("lodash"),PaymentHold=require("./components/messaging/paymentHold.js"),ConsolidatedLogging=require("../utils/consolidatedLogging/index"),EventBus=require("../reactMixins/eventBus"),HistoryBack=require("../reactMixins/historyBack"),ProfileManager=require("../utils/profileManager"),IsomorphicContext=require("../reactMixins/isomorphicContextWithDeps"),ONE_PREVIOUS_PAGE=1,UI_VIEWS={home:"homeScreen",title:"homeScreen",addToMyList:"homeScreen",genre:"browseTitles",similars:"WiSimilarsByViewType",genreNewRelease:"NewReleases",hd:"browseTitles",person:"rolesDisplay",myList:"MyListAsGallery",watchAgain:"WiAgain",recentlyAdded:"WiRecentAdditions",newRelease:"NewReleases",newReleases:"NewReleases",newArrivals:"NewReleases",subtitle:"browseTitles",subtitles:"browseTitles",search:"searchResults",searchPerson:"searchResults",searchSuggestion:"searchResults",searchDVD:"searchResults",playback:"playback",watchNow:"playback",audioDescription:"browseTitles"},BaseRouteHandler=React.createClass({displayName:"BaseRouteHandler",mixins:[Router.Navigation,Router.State,HistoryBack,IsomorphicContext],getInitialState:function(){var e=ProfileManager.VIEWS,t=this.getFeatureData("showGate")===!0?e.LIST:e.CLOSED;return{initializedCL:!1,profileGateAppState:{activeView:t}}},isInAkiraDiscovery:function(){var e=_.get(this.getRoutes(),"[1].name",null);return"akira"===e},getRouteName:function(){var e=this.getRoutes(),t=e&&e.length>0&&e[e.length-1],i=t&&t.name;return i},getCurrentUIView:function(){var e=this.getRouteName(),t=e&&UI_VIEWS[e];return t},isPlaybackView:function(){return"playback"===this.getCurrentUIView()},componentWillMount:function(){var e;"client"!==this.props.renderSource||this.state.initializedCL||(e=this.getCurrentUIView(),e&&(this.state.initializedCL=!0,initConsolidatedLogging(e)))},updateProfileGateAppState:function(e){this.isInAkiraDiscovery()&&(this.setState({profileGateAppState:e}),e.activeView===ProfileManager.VIEWS.CLOSED&&this.replaceWith(this.getRouteName(),this.getParams()))},paymentHoldModalClose:function(){this.isPlaybackView()&&this.goBackHistory(ONE_PREVIOUS_PAGE)},drawPaymentHold:function(){ProfileManager.isGateOpen(this.state.profileGateAppState)||PaymentHold.potentiallyOpen({umaData:this.getFeatureData("umaData")||null},this.isPlaybackView())},componentDidMount:function(){ProfileManager.init(this.updateProfileGateAppState),EventBus.on("modal:close:paymentHoldModal",this.paymentHoldModalClose),this.drawPaymentHold()},componentDidUpdate:function(){EventBus.removeListener("modal:close:paymentHoldModal",this.paymentHoldModalClose),this.drawPaymentHold()},render:function(){return PaymentHold.preventPlay(this.getFeatureData("umaData"))&&this.isPlaybackView()?null:React.createElement(Router.RouteHandler,React.__spread({},this.props,{uiView:this.getCurrentUIView(),profileGateAppState:this.state.profileGateAppState,renderSource:this.props.renderSource}))}});module.exports=BaseRouteHandler;
...
"use strict";var _=require("lodash"),React=require("react"),Router=require("react-router"),Title=require("./title.jsx"),IsomorphicContext=require("../../reactMixins/isomorphicContextWithDeps"),EventBus=require("../../reactMixins/eventBus"),MyListUtils=require("../../utils/mylist_utils");module.exports=React.createClass({displayName:"exports",mixins:[Router.State,IsomorphicContext],componentDidMount:function(){var t=this.getQuery(),e=t.msg_token,i=this.context.trackId||0,s=parseInt(this.getParams().id,10),r=decodeURIComponent(e).replace(/ /g,"+");EventBus.emit("myList:add:start",_.assign({},this.context,this.props)),MyListUtils.addToList(s,i,this.triggerNotification,this.triggerNotification,{reqMsgToken:!0,msgToken:r})},triggerNotification:function(t){EventBus.emit("myList:add:end",_.assign({},this.context,this.props,{myListNotification:t}))},render:function(){return React.createElement(Title,React.__spread({},this.props))}});
...
"use strict";var Rx=require("../../common/nfRx"),contextData=require("../../utils/contextData"),netflix=require("../../common/nfNamespace"),_=require("lodash"),ASSET_LOAD_SLA=5e3,RETRY_COUNT=5,RETRY_DELAY=1e3,jsLoadObs,cssLoadObs,coreJsLoadObs,makeLoadObservable=function(e,r){return Rx.Observable.fromEvent(e,"load").merge(Rx.Observable.fromEvent(e,"error").map(function(){return Rx.Observable.throwError(new Error(r))})).timeout(ASSET_LOAD_SLA).retryWithBackoff(RETRY_COUNT,RETRY_DELAY).shareReplay()};module.exports={getPlayerCSS:function(e){if(cssLoadObs)return cssLoadObs;var r=document.createElement("link");cssLoadObs=makeLoadObservable(r,"Loading CSS Resource failed."),r.href=e,r.type="text/css",r.rel="stylesheet";var s=document.getElementsByTagName("head")[0];return s.appendChild(r),cssLoadObs},getCorePlayerJS:function(e){if(coreJsLoadObs)return coreJsLoadObs;var r=document.createElement("script");return coreJsLoadObs=makeLoadObservable(r,"Loading Core JS Resource failed."),r.src=e,document.body.appendChild(r),coreJsLoadObs},getPlayerJS:function(e){if(jsLoadObs)return jsLoadObs;var r=document.createElement("script");return jsLoadObs=makeLoadObservable(r,"Loading JS Resource failed."),r.src=e,document.body.appendChild(r),jsLoadObs},getPlayerAssets:function(){var e=contextData.getData("player","config"),r=contextData.getFeatureData("fastProps"),s=r["wwwplayer.asset.ui.identifier"],t=r["wwwplayer.asset.ui.url"];if(e.ui=e.ui||{},e.core=e.core||{},!e.ui.assets&&!e.core.assets&&!e.ui.isFallback)return Rx.Observable.throw(new Error("No assets defined!"));var a,o=_.merge(e.ui.assets,e.core.assets||{}),n=[this.getPlayerCSS(o.css),this.getPlayerJS(o.js)];return s&&t?(a=t+s+"/mdx_cros_v2.js",n.push(this.getCorePlayerJS(o.core))):a=netflix.reactContext.fastProps["wwwplayer.mdx"],netflix.constants=netflix.constants||{},netflix.constants.page=netflix.constants.page||{},netflix.constants.page.merchMdxJs=a,Rx.Observable.zip(n,_.noop)}};
...
"use strict";var Rx=require("../../common/nfRx"),ImageExt=require("../../common/imageExtension.js"),XHR=require("../XHR"),_imageExtension;module.exports={getMetadataCall:function(e){return _imageExtension=ImageExt.canUseWebPFromContext()?"webp":"jpg",Rx.Observable.create(function(t){return XHR.request({method:"get",service:"api",data:{movieid:e,imageFormat:_imageExtension},resource:"/metadata",authorize:!1}).subscribe(function(e){t.onNext(e)},function(e){t.onError(e)},function(){t.onCompleted()})})},getCharacterMetadataCall:function(e){return _imageExtension=ImageExt.canUseWebPFromContext()?"webp":"jpg",Rx.Observable.create(function(t){return XHR.request({method:"get",service:"api",data:{characterId:e,imageFormat:_imageExtension},resource:"/metadata",authorize:!1}).subscribe(function(e){t.onNext(e)},function(e){t.onError(e)},function(){t.onCompleted()})})}};
...
"use strict";var React=require("react"),App=require("../akira/app.jsx"),PathEvaluator=require("../falkorClient/PathEvaluator"),loader=require("../falkorClient/falkorLoader"),logger=require("../utils/consolidatedLogging/index"),PerformanceMetrics=require("../utils/performanceMetrics"),netflix=require("../common/nfNamespace"),consLog=require("nf-cons-log"),presentationTracking=require("../common/presentationTracking/presentationTracking"),PlayerAssets=require("../utils/player/playerAssets"),contextData=require("../utils/contextData"),playPrediction=require("../common/playPrediction/playPrediction"),hasLoggedStartup=!1,noop=function(){},siteMountainPage={APP_MOUNT:"appMountPoint",sendStartupTiming:function(){function e(){var e=PerformanceMetrics.getMetrics();e&&logger.logStartup(e)}var t=20,a=window||{};"complete"===document.readyState?setTimeout(e,t):a.onload=setTimeout.bind(a,e,t)},init:function(){if(!this.inNode){try{consLog.clientNotifications.start()}catch(e){}presentationTracking.init(),playPrediction.stub||playPrediction.init()}var t=new PathEvaluator(5e6,.75,loader).toAggregate().deserialize(netflix.falkorCache).toRoot(),a=this,r=window||{};r.pathEvaluator=t;var n,i=netflix.reactContext;i.pathEvaluator=t,i.node={req:null,res:null},window.addEventListener("load",function(){var e=contextData.getData("player","config"),t=contextData.getData("player","kidsPlayer"),a=contextData.getData("player","playbackSupport")||{supportsHTML5:"no"};!t&&"no"!==a.supportsHTML5&&e&&PlayerAssets.getPlayerAssets().take(1).subscribe(noop,function(){},noop)}),r.reactApp=new App(i),r.reactApp.clientRender(function(e,t){if(e)throw e.stack,e;n=React.render(t,document.getElementById(a.APP_MOUNT)),r.reactApp.setRenderedView(n),hasLoggedStartup||(a.sendStartupTiming(),hasLoggedStartup=!0)})}};"undefined"!=typeof window&&siteMountainPage.init();
